  ...
  (function (a) {
    ...
    function b(b) {
      ...
      if (
        ...
        "axis" in g && g.axis === g.HORIZONTAL_AXIS && ((k = -1 * l), (l = 0)),
        (j = 0 === l ? k : l),
...
(jvm.$ = jQuery),
  ...
  (jvm.AbstractShapeElement.prototype.updateStyle = function () {
    ...
    jvm.AbstractShapeElement.mergeStyles(a, this.style.initial),
      ...
      this.isSelected &&
        ...
        this.isHovered &&
          jvm.AbstractShapeElement.mergeStyles(a, this.style.selectedHover)),
      this.set(a);
  }),
      ...
      ? jvm.SVGShapeElement.images[b]
        ...
        : jvm.whenImageLoaded(b).then(function (a) {
            (d = new jvm.SVGElement("image")),
              d.node.setAttributeNS("http://www.w3.org/1999/xlink", "href", b),
              d.applyAttr("x", "0"),
              d.applyAttr("y", "0"),
              d.applyAttr("width", a[0].width),
              d.applyAttr("height", a[0].height),
              (c = new jvm.SVGElement("pattern")),
              c.applyAttr("id", "image" + jvm.SVGShapeElement.imageCounter),
              c.applyAttr("x", 0),
              c.applyAttr("y", 0),
              c.applyAttr("width", a[0].width / 2),
              c.applyAttr("height", a[0].height / 2),
              c.applyAttr("viewBox", "0 0 " + a[0].width + " " + a[0].height),
  ...
  (jvm.SVGImageElement.prototype.applyAttr = function (a, b) {
    ...
    "image" == a
      ? jvm.whenImageLoaded(b).then(function (a) {
          c.node.setAttributeNS("http://www.w3.org/1999/xlink", "href", b),
            (c.width = a[0].width),
            (c.height = a[0].height),
      ...
      : "cx" == a
      ? ((this.cx = b), this.width && this.applyAttr("x", b - this.width / 2))
      : "cy" == a
      ? ((this.cy = b), this.height && this.applyAttr("y", b - this.height / 2))
  ...
  (jvm.VMLCanvasElement.prototype.setSize = function (a, b) {
    ...
    if (
      ...
      for (
        d = this.node.getElementsByTagName("group"), e = 0, f = d.length;
        f > e;
        e++
      )
        (d[e].coordsize = a + " " + b),
  ...
  (jvm.NumericScale.prototype = {
    setMin: function (a) {
      (this.clearMinValue = a),
        (this.minValue =
          "function" == typeof this.normalize ? this.normalize(a) : a);
    },
    setMax: function (a) {
    ...
    getValue: function (a) {
      var b,
        ...
        f = 0;
      for (
        "function" == typeof this.normalize && (a = this.normalize(a)), f = 0;
        ...
        (b = this.vectorLength(
          ...
          d.push(b),
          (e += b);
      for (c = (this.maxValue - this.minValue) / e, f = 0; f < d.length; f++)
        d[f] *= c;
    ...
    getTicks: function () {
      ...
      for (
        ...
        (b =
          a == c[0] ? this.clearMinValue : a == c[1] ? this.clearMaxValue : a),
  ...
  (jvm.Legend.prototype.render = function () {
    ...
    for (
      ...
      b.append(c),
        ...
        b.append(
          jvm.$("<div>" + d + " </div>").addClass("jvectormap-legend-tick-text")
        ),
        f.append(b);
    }
      ...
      jvm.$.isArray(a.scale)
        ? ((d =
            "fill" === a.attribute || "stroke" === a.attribute
              ? jvm.ColorScale
              : jvm.NumericScale),
          (this.scale = new d(a.scale, a.normalizeFunction, a.min, a.max)))
        : (this.scale = a.scale
  ...
  (jvm.DataSeries.prototype = {
    setAttributes: function (a, b) {
      var c,
        d = a;
      if ("string" == typeof a)
        this.elements[a] && this.elements[a].setStyle(this.params.attribute, b);
      else
        for (c in d)
          this.elements[c] &&
            this.elements[c].element.setStyle(this.params.attribute, d[c]);
    },
      ...
      if (
        ...
        for (c in a)
          f[c] = a[c]
            ...
            : this.elements[c].element.style.initial[this.params.attribute];
      else {
        if (void 0 === this.params.min || void 0 === this.params.max)
          for (c in a)
            (b = parseFloat(a[c])), b > d && (d = b), e > b && (e = b);
  ...
  (jvm.Proj = {
    ...
    mill: function (a, b, c) {
      return {
        ...
        y:
          (-this.radius * Math.log(Math.tan((45 + 0.4 * a) * this.radDeg))) /
          0.8,
      };
    },
    ...
    lcc: function (a, b, c) {
      var d = c * this.radDeg,
        ...
        i =
          ...
          Math.log(
            Math.tan(Math.PI / 4 + g / 2) * (1 / Math.tan(Math.PI / 4 + f / 2))
          ),
    ...
    lcc_inv: function (a, b, c) {
      var d = a / this.radius,
        ...
        i =
          ...
          Math.log(
            Math.tan(Math.PI / 4 + h / 2) * (1 / Math.tan(Math.PI / 4 + g / 2))
          ),
      ...
      return {
        lat:
          (2 * Math.atan(Math.pow(j / l, 1 / i)) - Math.PI / 2) * this.degRad,
        lng: (f + m / i) * this.degRad,
      };
    },
  }),
  ...
  (jvm.MapObject.prototype.setHovered = function (a) {
    this.isHovered !== a &&
      ...
      this.label && ((this.label.isHovered = a), this.label.updateStyle()));
  }),
  (jvm.MapObject.prototype.setSelected = function (a) {
    this.isSelected !== a &&
      ...
      this.shape.updateStyle(),
      this.label && ((this.label.isSelected = a), this.label.updateStyle()),
  ...
  (jvm.Map.prototype = {
          ...
          "touchstart" == i.type && (g = 0),
            1 == n.length
              ? (1 == g &&
                  ...
                  h.applyTransform(),
                  h.tip.hide(),
                  (l != h.transX || m != h.transY) && i.preventDefault()),
                (c = n[0].pageX),
                (d = n[0].pageY))
              : 2 == n.length &&
                (2 == g
      ...
      var a = this,
        ...
        e = function (b) {
          ...
          (0 != b.translationX || 0 != b.translationY) &&
            ...
            1 != b.scale &&
              (a.setScale(a.scale * b.scale, b.offsetX, b.offsetY),
              a.tip.hide(),
              b.preventDefault());
        };
      (b.target = c),
          ...
          function () {
            ...
            c ||
              ...
              (("region" === b && d.params.regionsSelectable) ||
                ("marker" === b && d.params.markersSelectable)) &&
                (f.isDefaultPrevented() ||
                  (d.params[b + "sSelectableOne"] && d.clearSelected(b + "s"),
    ...
    setScale: function (a, b, c, d, e) {
      var f,
        ...
        q = 0,
        r = Math.abs(
          Math.round((60 * (a - this.scale)) / Math.max(a, this.scale))
        ),
        s = new jvm.$.Deferred();
      return (
        ...
        void 0 !== b &&
          ...
          d
            ? ((m =
                b +
                (this.defaultWidth * (this.width / (this.defaultWidth * a))) /
                  2),
              (n =
                c +
                (this.defaultHeight *
    ...
    setFocus: function (a) {
          ...
          this.regions[e[f]] &&
            ...
            (void 0 === b
              ...
              : ((d = {
                  ...
                  y: Math.min(b.y, c.y),
                  width:
                    Math.max(b.x + b.width, c.x + c.width) - Math.min(b.x, c.x),
                  height:
      ...
      return (
        a.lat && a.lng
          ...
          : a.x &&
            a.y &&
            ((a.x *= -this.defaultWidth), (a.y *= -this.defaultHeight)),
    ...
    latLngToPoint: function (a, b) {
      ...
      return (
        ...
        !!(d = this.getInsetForPoint(c.x, c.y)) &&
          ((e = d.bbox),
          (c.x = ((c.x - e[0].x) / (e[1].x - e[0].x)) * d.width * this.scale),
    ...
    pointToLatLng: function (a, b) {
      ...
      for (c = 0; c < j.length; c++)
        if (
          ...
          (f = (f / (d.width * this.scale)) * (e[1].x - e[0].x) + e[0].x),
          (g = (g / (d.height * this.scale)) * (e[1].y - e[0].y) + e[0].y),
  ...
  (jvm.MultiMap.prototype = {
    ...
    goBack: function () {
      var a = this.history.pop(),
        ...
        c = this;
      a.setFocus({ scale: 1, x: 0.5, y: 0.5, animate: !0 }).then(function () {
