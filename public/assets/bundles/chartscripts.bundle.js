      ...
      2: [
        function (a, b, c) {
          var d = a(4),
            ...
            f = function (a) {
              ...
              if ("string" == typeof a)
                ...
                if (((b = a), void 0 !== b.r || void 0 !== b.red))
          ...
          (f.prototype = {
            ...
            hue: function (a) {
              return (
                a && ((a %= 360), (a = a < 0 ? 360 + a : a)),
                this.setChannel("hsl", 0, a)
              );
            },
            ...
            rotate: function (a) {
              var b = this.values.hsl,
                c = (b[0] + a) % 360;
              return (
                (b[0] = c < 0 ? 360 + c : c), this.setValues("hsl", b), this
              );
            },
            mix: function (a, b) {
              var c = this,
            ...
            (f.prototype.getValues = function (a) {
              for (var b = this.values, c = {}, d = 0; d < a.length; d++)
                c[a.charAt(d)] = b[a][d];
            ...
            (f.prototype.setValues = function (a, b) {
              ...
              if ("alpha" === a) h = b;
                ...
                (e[a] = b.slice(0, a.length)), (h = b[a.length]);
              ...
              for (c = 0; c < a.length; c++)
                (j = Math.max(0, Math.min(g[a][c], e[a][c]))),
                  (e[a][c] = Math.round(j));
        ...
        function (a, c, d) {
          ...
          function k(a) {
            ...
            return (
              ...
              [
                100 * (0.4124 * b + 0.3576 * c + 0.1805 * d),
          ...
          function I(a) {
            var b,
              ...
              g = a[2] / 100;
            return (
              (b = 3.2406 * e + -1.5372 * f + -0.4986 * g),
              (c = -0.9689 * e + 1.8758 * f + 0.0415 * g),
              (d = 0.0557 * e + -0.204 * f + 1.057 * g),
              (b =
                b > 0.0031308
          ...
          function L(a) {
            ...
            return (
              f <= 8
                ? ((c = (100 * f) / 903.3), (e = (c / 100) * 7.787 + 16 / 116))
          ...
          !(function (b, e) {
            ...
            function r(b) {
              q(this, b),
                ...
                !1 === qd && ((qd = !0), a.updateOffset(this), (qd = !1));
            }
            function s(a) {
              return (
                a instanceof r || (null != a && null != a._isAMomentObject)
              );
            }
            function t(a) {
            ...
            function B(a, b) {
              ...
              for (c in b)
                i(b, c) &&
                  (e(a[c]) && e(b[c])
                    ? ((d[c] = {}), j(d[c], a[c]), j(d[c], b[c]))
                    : null != b[c]
                    ? (d[c] = b[c])
                    : delete d[c]);
              for (c in a)
                i(a, c) && !i(b, c) && e(a[c]) && (d[c] = j({}, d[c]));
              return d;
            }
            function C(a) {
              null != a && this.set(a);
            ...
            function Y(a, b) {
              ...
              var d = 5;
              for (Bd.lastIndex = 0; d >= 0 && Bd.test(a); )
                (a = a.replace(Bd, c)), (Bd.lastIndex = 0), (d -= 1);
              return a;
            }
            function Z(a, b, c) {
              Vd[a] = z(b)
            ...
            function fa(a, b) {
              return d(this._months)
                ? this._months[a.month()]
                : this._months[
                    (this._months.isFormat || ee).test(b)
                      ? "format"
                      : "standalone"
                  ][a.month()];
            }
            function ga(a, b) {
              return d(this._monthsShort)
                ? this._monthsShort[a.month()]
                : this._monthsShort[ee.test(b) ? "format" : "standalone"][
                    a.month()
                  ];
            }
            function ha(a, b, c) {
              ...
              return c
                ? "MMM" === b
                  ? ((e = td.call(this._shortMonthsParse, g)),
                    -1 !== e ? e : null)
                  : ((e = td.call(this._longMonthsParse, g)),
                    -1 !== e ? e : null)
                : "MMM" === b
                ? -1 !== (e = td.call(this._shortMonthsParse, g))
                  ? e
                  : ((e = td.call(this._longMonthsParse, g)),
                    -1 !== e ? e : null)
                : -1 !== (e = td.call(this._longMonthsParse, g))
                ? e
                : ((e = td.call(this._shortMonthsParse, g)),
                  -1 !== e ? e : null);
            }
            ...
            function na(a) {
              return this._monthsParseExact
                ...
                : (i(this, "_monthsRegex") || (this._monthsRegex = ie),
            ...
            function Ia(a, b, c) {
              ...
              return c
                ? "dddd" === b
                  ? ((e = td.call(this._weekdaysParse, g)), -1 !== e ? e : null)
                  : "ddd" === b
                  ? ((e = td.call(this._shortWeekdaysParse, g)),
                    -1 !== e ? e : null)
                  : ((e = td.call(this._minWeekdaysParse, g)),
                    -1 !== e ? e : null)
                : "dddd" === b
                ? -1 !== (e = td.call(this._weekdaysParse, g))
                  ? e
                  : -1 !== (e = td.call(this._shortWeekdaysParse, g))
                  ? e
                  : ((e = td.call(this._minWeekdaysParse, g)),
                    -1 !== e ? e : null)
                : "ddd" === b
                ? -1 !== (e = td.call(this._shortWeekdaysParse, g))
                  ...
                  : ((e = td.call(this._minWeekdaysParse, g)),
                    -1 !== e ? e : null)
                : -1 !== (e = td.call(this._minWeekdaysParse, g))
                ? e
                : -1 !== (e = td.call(this._weekdaysParse, g))
                ? e
                : ((e = td.call(this._shortWeekdaysParse, g)),
            ...
            function Na(a) {
              return this._weekdaysParseExact
                ...
                : (i(this, "_weekdaysRegex") || (this._weekdaysRegex = oe),
                ...
                return (
                  ...
                  null != ve[a]
                    ? (y(
                      ...
                      (c = ve[a]._config))
                    : null != b.parentLocale &&
                      (null != ve[b.parentLocale]
                        ? (c = ve[b.parentLocale]._config)
                        : y(
              ...
              return (
                c &&
                  ...
                  ((b =
                    c[Yd] < 0 || c[Yd] > 11
                      ? Yd
                      : c[Zd] < 1 || c[Zd] > ea(c[Xd], c[Yd])
                      ? Zd
                      : c[$d] < 0 ||
                        c[$d] > 24 ||
                        (24 === c[$d] &&
                          (0 !== c[_d] || 0 !== c[ae] || 0 !== c[be]))
                      ? $d
                      : c[_d] < 0 || c[_d] > 59
                      ? _d
                      : c[ae] < 0 || c[ae] > 59
                      ...
                      ? be
                      : -1),
                  m(a)._overflowDayOfYear && (b < Xd || b > Zd) && (b = Zd),
                  m(a)._overflowWeeks && -1 === b && (b = ce),
                  m(a)._overflowWeekday && -1 === b && (b = de),
                  (m(a).overflow = b)),
                a
              );
            }
            ...
            function ib(a) {
              ...
              if (!a._d) {
                for (
                  d = hb(a),
                    a._w && null == a._a[Zd] && null == a._a[Yd] && jb(a),
                    a._dayOfYear &&
                      ((e = gb(a._a[Xd], d[Xd])),
                      a._dayOfYear > pa(e) && (m(a)._overflowDayOfYear = !0),
                      (c = ta(e, 0, a._dayOfYear)),
                      (a._a[Yd] = c.getUTCMonth()),
                      (a._a[Zd] = c.getUTCDate())),
                    b = 0;
                  b < 3 && null == a._a[b];
                  ++b
                )
                ...
                24 === a._a[$d] &&
                  ...
                  0 === a._a[ae] &&
                  0 === a._a[be] &&
                  ((a._nextDay = !0), (a._a[$d] = 0)),
                  (a._d = (a._useUTC ? ta : sa).apply(null, f)),
                  null != a._tzm &&
                    a._d.setUTCMinutes(a._d.getUTCMinutes() - a._tzm),
                  a._nextDay && (a._a[$d] = 24);
              }
            }
            function jb(a) {
              var b, c, d, e, f, g, h, i;
              (b = a._w),
                null != b.GG || null != b.W || null != b.E
                  ? ((f = 1),
                    (g = 4),
                    (c = gb(b.GG, a._a[Xd], wa(sb(), 1, 4).year)),
                    (d = gb(b.W, 1)),
                    ((e = gb(b.E, 1)) < 1 || e > 7) && (i = !0))
                  : ((f = a._locale._week.dow),
                    (g = a._locale._week.doy),
                    (c = gb(b.gg, a._a[Xd], wa(sb(), f, g).year)),
                    (d = gb(b.w, 1)),
                    null != b.d
                      ? ((e = b.d) < 0 || e > 6) && (i = !0)
                      : null != b.e
            ...
            function kb(b) {
              ...
              var c,
                ...
                j = 0;
              for (
                e = Y(b._f, b._locale).match(Ad) || [], c = 0;
                c < e.length;
                c++
              )
                (f = e[c]),
              ...
              (m(b).charsLeftOver = i - j),
                ...
                (b._a[$d] = lb(b._locale, b._a[$d], b._meridiem)),
                ib(b),
                db(b);
            }
            function lb(a, b, c) {
              ...
              return (
                ...
                null === b || (void 0 === c && "" === b)
                  ...
                  : ("string" == typeof b && (a._i = b = a._locale.preparse(b)),
                    s(b)
                      ? new r(db(b))
                      : (d(c) ? mb(a) : g(b) ? (a._d = b) : c ? kb(a) : qb(a),
                        n(a) || (a._d = null),
                        a))
              );
            }
            ...
            function Ab(b, c) {
              ...
              return c._isUTC
                ? ((d = c.clone()),
                  (e =
                    (s(b) || g(b) ? b.valueOf() : sb(b).valueOf()) -
                    d.valueOf()),
            ...
            function Vb(b, c) {
              ...
              return this.format(
                g || this.localeData().calendar(f, this, sb(d))
              );
            }
            function Wb() {
              return new r(this);
            ...
            function nc(a) {
              return void 0 === (a = K(a)) || "millisecond" === a
                ? this
                : ("date" === a && (a = "day"),
                  this.startOf(a)
            ...
            function Vc() {
              ...
              return (
                ...
                (a.milliseconds = Te(a.milliseconds)),
                (a.seconds = Te(a.seconds)),
                (a.minutes = Te(a.minutes)),
                (a.hours = Te(a.hours)),
                (a.months = Te(a.months)),
                (a.years = Te(a.years)),
                this
              );
            }
            ...
            function jd(a) {
              return void 0 === a
                ? hf
                : "function" == typeof a && ((hf = a), !0);
            }
            function kd(a, b) {
              return (
                void 0 !== jf[a] && (void 0 === b ? jf[a] : ((jf[a] = b), !0))
              );
            }
            function ld(a) {
            ...
            (Qe.add = Ie),
              ...
              (Qe.weekYear = zc),
              (Qe.isoWeekYear = Ac),
              (Qe.quarter = Qe.quarters = Fc),
              (Qe.month = ka),
              (Qe.daysInMonth = la),
              (Qe.week = Qe.weeks = Ba),
              (Qe.isoWeek = Qe.isoWeeks = Ca),
              (Qe.weeksInYear = Cc),
              (Qe.isoWeeksInYear = Bc),
              (Qe.date = Le),
              (Qe.day = Qe.days = Ka),
              (Qe.weekday = La),
              (Qe.isoWeekday = Ma),
              (Qe.dayOfYear = Gc),
              (Qe.hour = Qe.hours = te),
              (Qe.minute = Qe.minutes = Me),
              (Qe.second = Qe.seconds = Ne),
              (Qe.millisecond = Qe.milliseconds = Pe),
              (Qe.utcOffset = Cb),
              (Qe.utc = Eb),
              (Qe.local = Fb),
              (Qe.parseZone = Gb),
              (Qe.hasAlignedHourOffset = Hb),
              (Qe.isDST = Ib),
              (Qe.isLocal = Kb),
              (Qe.isUtcOffset = Lb),
              (Qe.isUtc = Mb),
            ...
            (Se.calendar = D),
              ...
              (Se.monthsParse = ia),
              (Se.monthsRegex = na),
              (Se.monthsShortRegex = ma),
              (Se.week = ya),
              (Se.firstDayOfYear = Aa),
              (Se.firstDayOfWeek = za),
              (Se.weekdays = Fa),
              (Se.weekdaysMin = Ha),
              (Se.weekdaysShort = Ga),
              (Se.weekdaysParse = Ja),
              (Se.weekdaysRegex = Na),
              (Se.weekdaysShortRegex = Oa),
              (Se.weekdaysMinRegex = Pa),
              (Se.isPM = Va),
              (Se.meridiem = Wa),
              $a("en", {
            ...
            return (
              ...
              (a.weekdaysShort = Tc),
              (a.normalizeUnits = K),
              (a.relativeTimeRounding = jd),
              (a.relativeTimeThreshold = kd),
              (a.calendarFormat = Ub),
              (a.prototype = Re),
              a
            );
        ...
        function (a, b, c) {
          ...
          b.exports = function (a) {
            a.Radar = function (b, c) {
              return (
                (c.options = a.helpers.configMerge(
                  { aspectRatio: 1 },
                  c.options
                )),
                (c.type = "radar"),
            ...
            (a.defaults.bar = {
              ...
              (a.controllers.bar = a.DatasetController.extend({
                ...
                initialize: function (b, c) {
                  a.DatasetController.prototype.initialize.call(this, b, c),
                    (this.getMeta().bar = !0);
                },
                getBarCount: function () {
                  ...
                  return (
                    b.each(
                      ...
                      function (b, d) {
                        a.chart.getDatasetMeta(d).bar &&
                          a.chart.isDatasetVisible(d) &&
                          ++c;
                      },
                      a
                    ),
                  ...
                  b.extend(a, {
                    ...
                    _model: {
                      ...
                      backgroundColor: k.backgroundColor
                        ? k.backgroundColor
                        : b.getValueAtIndexOrDefault(
                            l.backgroundColor,
                            c,
                            j.backgroundColor
                          ),
                      borderSkipped: k.borderSkipped
                        ? k.borderSkipped
                        : j.borderSkipped,
                ...
                getRuler: function (a) {
                  var b,
                    ...
                    f = c.getBarCount();
                  b =
                    "category" === e.options.type
                      ? e.getPixelForTick(a + 1) - e.getPixelForTick(a)
                      : e.width / e.ticks.length;
                ...
                getBarIndex: function (a) {
                  var b,
                    ...
                    d = 0;
                  for (c = 0; c < a; ++c)
                    (b = this.chart.getDatasetMeta(c)),
                      b.bar && this.chart.isDatasetVisible(c) && ++d;
                  return d;
                },
                calculateBarX: function (a, b) {
                  ...
                  return (
                    (h -= c.chart.isCombo ? g.tickWidth / 2 : 0),
                    e.options.stacked
                      ? h + g.categoryWidth / 2 + g.categorySpacing
                      : h +
                        g.barWidth / 2 +
                        g.categorySpacing +
                        g.barWidth * f +
                ...
                setHoverStyle: function (a) {
                  ...
                  (f.backgroundColor = e.hoverBackgroundColor
                    ...
                    : b.getValueAtIndexOrDefault(
                        ...
                        d,
                        b.getHoverColor(f.backgroundColor)
                      )),
                    (f.borderColor = e.hoverBorderColor
                      ? e.hoverBorderColor
                      : b.getValueAtIndexOrDefault(
                          c.hoverBorderColor,
                          d,
                          b.getHoverColor(f.borderColor)
                        )),
                    (f.borderWidth = e.hoverBorderWidth
                      ? e.hoverBorderWidth
                      : b.getValueAtIndexOrDefault(
                          c.hoverBorderWidth,
                          d,
                      ...
                      return (
                        a.length > 0 &&
                          (a[0].yLabel
                            ? (c = a[0].yLabel)
                            : b.labels.length > 0 &&
                              a[0].index < b.labels.length &&
                              (c = b.labels[a[0].index])),
                        c
                      );
                    },
                    label: function (a, b) {
                      return (
                        (b.datasets[a.datasetIndex].label || "") +
                        ": " +
                        a.xLabel
                      );
                    },
              ...
              (a.controllers.horizontalBar = a.controllers.bar.extend({
                  ...
                  b.extend(a, {
                    ...
                    draw: function () {
                      ...
                      var b = this._chart.ctx,
                        ...
                        g = c.base - (c.base - c.x),
                        h = c.borderWidth / 2;
                      c.borderWidth && ((e += h), (f -= h), (g += h)),
                        b.beginPath(),
                        (b.fillStyle = c.backgroundColor),
                        (b.strokeStyle = c.borderColor),
                        (b.lineWidth = c.borderWidth);
                      var i = [
                          [c.base, f],
                          [c.base, e],
                          [g, e],
                ...
                calculateBarY: function (a, b) {
                  var c = this,
                    ...
                    h = e.getPixelForValue(null, a, b, c.chart.isCombo);
                  return (
                    (h -= c.chart.isCombo ? g.tickHeight / 2 : 0),
                    e.options.stacked
                      ? h + g.categoryHeight / 2 + g.categorySpacing
                      : h +
                        g.barHeight / 2 +
                        g.categorySpacing +
                        g.barHeight * f +
              ...
              (a.controllers.bubble = a.DatasetController.extend({
                ...
                updateElement: function (c, d, e) {
                  ...
                  b.extend(c, {
                    ...
                    a.DatasetController.prototype.removeHoverStyle.call(
                      f,
                      c,
                      m
                    );
                  var o = c._model;
                  (o.skip = j.skip ? j.skip : isNaN(o.x) || isNaN(o.y)),
                    c.pivot();
                },
                ...
                setHoverStyle: function (c) {
                  ...
                  var e = d.chart.data.datasets[c._datasetIndex],
                    f = c._index,
                    g = c.custom || {};
                  c._model.radius = g.hoverRadius
                    ? g.hoverRadius
                    : b.getValueAtIndexOrDefault(
                        e.hoverRadius,
                        f,
                        d.chart.options.elements.point.hoverRadius
                      ) + d.getRadius(e.data[f]);
                },
                removeHoverStyle: function (b) {
                  ...
                  a.DatasetController.prototype.removeHoverStyle.call(
                    c,
                    b,
                    c.chart.options.elements.point
                  );
            ...
            (c.doughnut = {
              ...
              legendCallback: function (a) {
                ...
                var c = a.data,
                  ...
                  e = c.labels;
                if (d.length)
                  for (var f = 0; f < d[0].data.length; ++f)
                    b.push(
                      '<li><span style="background-color:' +
                        d[0].backgroundColor[f] +
                        '"></span>'
                    ),
                      e[f] && b.push(e[f]),
                      b.push("</li>");
              ...
              legend: {
                      ...
                      ? c.labels.map(function (d, e) {
                          ...
                          return {
                            ...
                            fillStyle: i.backgroundColor
                              ? i.backgroundColor
                              : j(g.backgroundColor, e, k.backgroundColor),
                            strokeStyle: i.borderColor
                              ? i.borderColor
                              : j(g.borderColor, e, k.borderColor),
                ...
                onClick: function (a, b) {
                  var c,
                    ...
                    f = b.index,
                    g = this.chart;
                  for (c = 0, d = (g.data.datasets || []).length; c < d; ++c)
                    (e = g.getDatasetMeta(c)),
              ...
              (c.pie = b.clone(c.doughnut)),
              b.extend(c.pie, { cutoutPercentage: 0 }),
              (a.controllers.doughnut = a.controllers.pie =
                a.DatasetController.extend({
                  dataElementType: a.elements.Arc,
                  linkScales: b.noop,
                  getRingIndex: function (a) {
                    for (var b = 0, c = 0; c < a; ++c)
                      this.chart.isDatasetVisible(c) && ++b;
                    return b;
                  },
                  update: function (a) {
                    var c = this,
                    ...
                    if (n < 2 * Math.PI) {
                      ...
                      o +=
                        2 *
                        Math.PI *
                        (o >= Math.PI ? -1 : o < -Math.PI ? 1 : 0);
                      var p = o + n,
                        q = { x: Math.cos(o), y: Math.sin(o) },
                        r = { x: Math.cos(p), y: Math.sin(p) },
                        s =
                          (o <= 0 && 0 <= p) ||
                          (o <= 2 * Math.PI && 2 * Math.PI <= p),
                        t =
                          (o <= 0.5 * Math.PI && 0.5 * Math.PI <= p) ||
                          (o <= 2.5 * Math.PI && 2.5 * Math.PI <= p),
                        u =
                          (o <= -Math.PI && -Math.PI <= p) ||
                          (o <= Math.PI && Math.PI <= p),
                        v =
                          (o <= 0.5 * -Math.PI && 0.5 * -Math.PI <= p) ||
                          (o <= 1.5 * Math.PI && 1.5 * Math.PI <= p),
                        w = m / 100,
                        x = {
                          x: u
                            ? -1
                      ...
                      (j = Math.min(h / z.width, i / z.height)),
                        (k = { x: -0.5 * (y.x + x.x), y: -0.5 * (y.y + x.y) });
                    }
                    (d.borderWidth = c.getMaxBorderWidth(l.data)),
                      (d.outerRadius = Math.max((j - d.borderWidth) / 2, 0)),
                      (d.innerRadius = Math.max(
                        m ? (d.outerRadius / 100) * m : 1,
                        0
                      )),
                      (d.radiusLength =
                        (d.outerRadius - d.innerRadius) /
                        d.getVisibleDatasetCount()),
                      (d.offsetX = k.x * d.outerRadius),
                      (d.offsetY = k.y * d.outerRadius),
                      (l.total = c.calculateTotal()),
                      (c.outerRadius =
                        d.outerRadius -
                        d.radiusLength * c.getRingIndex(c.index)),
                      (c.innerRadius = c.outerRadius - d.radiusLength),
                      b.each(l.data, function (b, d) {
                        c.updateElement(b, d, a);
                      });
                  },
                  updateElement: function (a, c, d) {
                    var e = this,
                      ...
                      o =
                        d && i.animateRotate
                          ...
                          : a.hidden
                          ? 0
                          : e.calculateCircumference(n.data[c]) *
                    ...
                    var s = a._model;
                    this.removeHoverStyle(a),
                      (d && i.animateRotate) ||
                        ((s.startAngle =
                          0 === c
                            ? h.rotation
                            : e.getMeta().data[c - 1]._model.endAngle),
                        (s.endAngle = s.startAngle + s.circumference)),
                      a.pivot();
                  },
                  removeHoverStyle: function (b) {
                    a.DatasetController.prototype.removeHoverStyle.call(
                  ...
                  calculateTotal: function () {
                    var a,
                      ...
                      e = 0;
                    return (
                      b.each(d.data, function (b, d) {
                        (a = c.data[d]),
                          isNaN(a) || b.hidden || (e += Math.abs(a));
                      }),
                      e
                    );
                  },
                  ...
                  getMaxBorderWidth: function (a) {
                    for (
                      var b, c, d = 0, e = this.index, f = a.length, g = 0;
                      g < f;
                      g++
                    )
                      (b = a[g]._model ? a[g]._model.borderWidth : 0),
                        (c = a[g]._chart
                          ? a[g]._chart.config.data.datasets[e].hoverBorderWidth
                          : 0),
                        (d = b > d ? b : d),
                        (d = c > d ? c : d);
                    return d;
              ...
              (a.controllers.line = a.DatasetController.extend({
                ...
                addElementAndReset: function (c) {
                  var d = this,
                    e = d.chart.options,
                    f = d.getMeta();
                  a.DatasetController.prototype.addElementAndReset.call(d, c),
                    b(d.getDataset(), e) &&
                      0 !== f.dataset._model.tension &&
                ...
                update: function (a) {
                  ...
                  for (
                    o &&
                      ((f = i.custom || {}),
                      void 0 !== n.tension &&
                        void 0 === n.lineTension &&
                        (n.lineTension = n.tension),
                      (i._scale = m),
                      (i._datasetIndex = g.index),
                      (i._children = j),
                      (i._model = {
                        spanGaps: n.spanGaps ? n.spanGaps : k.spanGaps,
                        tension: f.tension
                          ? f.tension
                          : c.getValueOrDefault(n.lineTension, l.tension),
                        backgroundColor: f.backgroundColor
                          ? f.backgroundColor
                          : n.backgroundColor || l.backgroundColor,
                        borderWidth: f.borderWidth
                          ? f.borderWidth
                          : n.borderWidth || l.borderWidth,
                        borderColor: f.borderColor
                          ? f.borderColor
                          : n.borderColor || l.borderColor,
                        borderCapStyle: f.borderCapStyle
                          ? f.borderCapStyle
                          : n.borderCapStyle || l.borderCapStyle,
                        borderDash: f.borderDash
                          ? f.borderDash
                          : n.borderDash || l.borderDash,
                        borderDashOffset: f.borderDashOffset
                          ? f.borderDashOffset
                          : n.borderDashOffset || l.borderDashOffset,
                        borderJoinStyle: f.borderJoinStyle
                          ? f.borderJoinStyle
                          : n.borderJoinStyle || l.borderJoinStyle,
                        fill: f.fill
                          ? f.fill
                          : void 0 !== n.fill
                          ? n.fill
                          : l.fill,
                        steppedLine: f.steppedLine
                          ? f.steppedLine
                          : c.getValueOrDefault(n.steppedLine, l.stepped),
                        scaleTop: m.top,
                    ...
                    g.updateElement(j[d], d, a);
                  for (
                    o &&
                      0 !== i._model.tension &&
                      g.updateBezierControlPoints(),
                      d = 0,
                      e = j.length;
                    d < e;
                    ++d
                ...
                getPointBackgroundColor: function (a, b) {
                  ...
                  return (
                    f.backgroundColor
                      ...
                      ? (d = c.getValueAtIndexOrDefault(
                          e.pointBackgroundColor,
                          b,
                          d
                        ))
                      : e.backgroundColor && (d = e.backgroundColor),
                    d
                  );
                },
                ...
                updateElement: function (a, b, d) {
                  ...
                  void 0 !== j.radius &&
                    void 0 === j.pointRadius &&
                    (j.pointRadius = j.radius),
                    void 0 !== j.hitRadius &&
                      void 0 === j.pointHitRadius &&
                      (j.pointHitRadius = j.hitRadius),
                    (e = n.getPixelForValue(
                      "object" == typeof l ? l : NaN,
                      b,
                      k,
                      g.chart.isCombo
                    )),
                    (f = d ? m.getBasePixel() : g.calculatePointY(l, b, k)),
                    (a._xScale = n),
                    (a._yScale = m),
                    (a._datasetIndex = k),
                    (a._index = b),
                    (a._model = {
                      ...
                      radius:
                        i.radius ||
                        c.getValueAtIndexOrDefault(j.pointRadius, b, o.radius),
                      pointStyle:
                        i.pointStyle ||
                        c.getValueAtIndexOrDefault(
                          j.pointStyle,
                      ...
                      steppedLine:
                        !!h.dataset._model && h.dataset._model.steppedLine,
                      hitRadius:
                        i.hitRadius ||
                        c.getValueAtIndexOrDefault(
                          j.pointHitRadius,
                ...
                calculatePointY: function (a, b, c) {
                  ...
                  if (j.options.stacked) {
                    for (d = 0; d < c; d++)
                      if (
                        ((e = h.data.datasets[d]),
                        (f = h.getDatasetMeta(d)),
                        "line" === f.type &&
                          f.yAxisID === j.id &&
                          h.isDatasetVisible(d))
                      ) {
                    ...
                    return n < 0
                      ? j.getPixelForValue(l + n)
                      : j.getPixelForValue(k + n);
                  }
                ...
                updateBezierControlPoints: function () {
                  ...
                  for (b = 0, d = k.length; b < d; ++b)
                    (e = k[b]),
                      (f = e._model),
                      (g = c.splineCurve(
                        c.previousItem(k, b)._model,
                        f,
                        c.nextItem(k, b)._model,
                        i.dataset._model.tension
                      )),
                      (f.controlPointPreviousX = a(
                        g.previous.x,
                        j.left,
                        j.right
                      )),
                      (f.controlPointPreviousY = a(
                        g.previous.y,
                        j.top,
                        j.bottom
                      )),
                      (f.controlPointNextX = a(g.next.x, j.left, j.right)),
                      (f.controlPointNextY = a(g.next.y, j.top, j.bottom));
                },
                draw: function (a) {
                  var c,
                    d,
                  ...
                  for (
                    b(e.getDataset(), e.chart.options) &&
                      f.dataset.transition(h).draw(),
                      c = 0,
                      d = g.length;
                    c < d;
                    ++c
                ...
                setHoverStyle: function (a) {
                  ...
                  (f.radius =
                    ...
                    (f.backgroundColor =
                      e.hoverBackgroundColor ||
                      c.getValueAtIndexOrDefault(
                        b.pointHoverBackgroundColor,
                        d,
                        c.getHoverColor(f.backgroundColor)
                      )),
                    (f.borderColor =
                      e.hoverBorderColor ||
                      c.getValueAtIndexOrDefault(
                        b.pointHoverBorderColor,
                        d,
                        c.getHoverColor(f.borderColor)
                      )),
                    (f.borderWidth =
                      e.hoverBorderWidth ||
                      c.getValueAtIndexOrDefault(
                        b.pointHoverBorderWidth,
                        d,
                        f.borderWidth
                      ));
                },
                  ...
                  void 0 !== d.radius &&
                    ...
                    (g.radius =
                      ...
                      c.getValueAtIndexOrDefault(
                        d.pointRadius,
                        e,
                        b.chart.options.elements.point.radius
                      )),
                    (g.backgroundColor = b.getPointBackgroundColor(a, e)),
                    (g.borderColor = b.getPointBorderColor(a, e)),
                    (g.borderWidth = b.getPointBorderWidth(a, e));
                },
              }));
          };
        },
            ...
            (a.defaults.polarArea = {
              ...
              (a.controllers.polarArea = a.DatasetController.extend({
                ...
                update: function (a) {
                  ...
                  (d.outerRadius = Math.max((i - h.borderWidth / 2) / 2, 0)),
                    (d.innerRadius = Math.max(
                      g.cutoutPercentage
                        ? (d.outerRadius / 100) * g.cutoutPercentage
                        : 1,
                    ...
                    (d.radiusLength =
                      (d.outerRadius - d.innerRadius) /
                      d.getVisibleDatasetCount()),
                    (c.outerRadius = d.outerRadius - d.radiusLength * c.index),
                    (c.innerRadius = c.outerRadius - d.radiusLength),
                    (f.count = c.countVisibleElements()),
                    b.each(f.data, function (b, d) {
                      c.updateElement(b, d, a);
                    });
                },
                updateElement: function (a, c, d) {
                  for (
                    var e = this,
                      ...
                      i = h.animation,
                      j = f.scale,
                      k = b.getValueAtIndexOrDefault,
                      l = f.data.labels,
                      m = e.calculateCircumference(g.data[c]),
                      n = j.xCenter,
                      o = j.yCenter,
                      p = 0,
                      q = e.getMeta(),
                    ...
                    isNaN(g.data[r]) || q.data[r].hidden || ++p;
                  var s = h.startAngle,
                    t = a.hidden
                      ? 0
                      : j.getDistanceFromCenterForValue(g.data[c]),
                    u = s + m * p,
                    v = u + (a.hidden ? 0 : m),
                    w = i.animateScale
                      ? 0
            ...
            (a.defaults.radar = {
              ...
              (a.controllers.radar = a.DatasetController.extend({
                  ...
                  void 0 !== h.tension &&
                    ...
                    b.extend(d.dataset, {
                      ...
                      _model: {
                        tension: g.tension
                          ? g.tension
                          : b.getValueOrDefault(h.lineTension, i.tension),
                  ...
                  b.extend(a, {
                    ...
                    _model: {
                      ...
                      tension: f.tension
                        ...
                        : b.getValueOrDefault(
                            g.tension,
                            e.chart.options.elements.line.tension
                          ),
                      radius: f.radius
                        ? f.radius
                        : b.getValueAtIndexOrDefault(
                    ...
                    (a._model.skip = f.skip
                      ? f.skip
                      : isNaN(a._model.x) || isNaN(a._model.y));
                },
                updateBezierControlPoints: function () {
                  ...
                  b.each(c.data, function (d, e) {
                    var f = d._model,
                      g = b.splineCurve(
                        b.previousItem(c.data, e, !0)._model,
                        f,
                        b.nextItem(c.data, e, !0)._model,
                        f.tension
                      );
                    (f.controlPointPreviousX = Math.max(
                      Math.min(g.previous.x, a.right),
                      a.left
                    )),
                      (f.controlPointPreviousY = Math.max(
                        Math.min(g.previous.y, a.bottom),
                        a.top
                      )),
                      (f.controlPointNextX = Math.max(
                        Math.min(g.next.x, a.right),
                        a.left
                      )),
                      (f.controlPointNextY = Math.max(
                        Math.min(g.next.y, a.bottom),
                        a.top
                      )),
                      d.pivot();
                  });
                ...
                setHoverStyle: function (a) {
                  ...
                  (f.radius = d.hoverRadius
                    ...
                    (f.backgroundColor = d.hoverBackgroundColor
                      ? d.hoverBackgroundColor
                      : b.getValueAtIndexOrDefault(
                          c.pointHoverBackgroundColor,
                          e,
                          b.getHoverColor(f.backgroundColor)
                        )),
                    (f.borderColor = d.hoverBorderColor
                      ? d.hoverBorderColor
                      : b.getValueAtIndexOrDefault(
                    ...
                    (f.borderWidth = d.hoverBorderWidth
                      ? d.hoverBorderWidth
                      : b.getValueAtIndexOrDefault(
                          c.pointHoverBorderWidth,
                          e,
                          f.borderWidth
                        ));
                },
                removeHoverStyle: function (a) {
                  ...
                  (f.radius = d.radius
                    ? d.radius
                    : b.getValueAtIndexOrDefault(c.radius, e, g.radius)),
              ...
              (a.animationService = {
                ...
                addAnimation: function (a, b, c, d) {
                  ...
                  for (var f = 0; f < e.animations.length; ++f)
                    if (e.animations[f].chartInstance === a)
                      return void (e.animations[f].animationObject = b);
                  e.animations.push({ chartInstance: a, animationObject: b }),
                ...
                cancelAnimation: function (a) {
                  ...
                  -1 !== c &&
                    (this.animations.splice(c, 1), (a.animating = !1));
                },
                ...
                startDigest: function () {
                  var a = this,
                    ...
                    c = 0;
                  a.dropFrames > 1 &&
                    ((c = Math.floor(a.dropFrames)),
                    (a.dropFrames = a.dropFrames % 1));
                  for (var d = 0; d < a.animations.length; )
                    null === a.animations[d].animationObject.currentStep &&
                      (a.animations[d].animationObject.currentStep = 0),
                      (a.animations[d].animationObject.currentStep += 1 + c),
                      a.animations[d].animationObject.currentStep >
                        a.animations[d].animationObject.numSteps &&
                        (a.animations[d].animationObject.currentStep =
                          a.animations[d].animationObject.numSteps),
                      a.animations[d].animationObject.render(
                        a.animations[d].chartInstance,
                        a.animations[d].animationObject
                      ),
                      a.animations[d].animationObject.onAnimationProgress &&
                        a.animations[d].animationObject.onAnimationProgress
                          .call &&
                        a.animations[
                          d
                      ...
                      a.animations[d].animationObject.numSteps
                        ? (a.animations[d].animationObject
                            .onAnimationComplete &&
                            a.animations[d].animationObject.onAnimationComplete
                              .call &&
                            a.animations[
                              d
                          ...
                          (a.animations[d].chartInstance.animating = !1),
                          a.animations.splice(d, 1))
                        : ++d;
                  var e = Date.now(),
                    f = (e - b) / a.frameDuration;
                  (a.dropFrames += f),
                    a.animations.length > 0 && a.requestAnimationFrame();
                },
              });
          };
        },
        ...
        function (a, b, c) {
          ...
          b.exports = function (a) {
            (a.canvasHelpers = {}).drawPoint = function (a, b, c, d, e) {
              ...
              if (
                "object" == typeof b &&
                ("[object HTMLImageElement]" === (f = b.toString()) ||
                  "[object HTMLCanvasElement]" === f)
              )
                return void a.drawImage(b, d - b.width / 2, e - b.height / 2);
              if (!(isNaN(c) || c <= 0)) {
                switch (b) {
                  default:
                    a.beginPath(),
            ...
            (a.types = {}),
              ...
              b.extend(a.Controller.prototype, {
                initialize: function () {
                  var b = this;
                  return (
                    a.plugins.notify("beforeInit", [b]),
                    b.bindEvents(),
                    b.ensureScalesHaveIDs(),
                    b.buildOrUpdateControllers(),
                    b.buildScales(),
                    b.updateLayout(),
                    b.resetElements(),
                    b.initToolTip(),
                    b.update(),
                    a.plugins.notify("afterInit", [b]),
                    b
                  );
                },
                clear: function () {
                ...
                resize: function (c) {
                  var d = this,
                    ...
                    h = e.aspectRatio,
                    i =
                      d.options.maintainAspectRatio &&
                      !1 === isNaN(h) &&
                      isFinite(h) &&
                      0 !== h
                        ? g / h
                        : b.getMaximumHeight(f);
                  ...
                  return (
                    a.plugins.notify("resize", [d, j]),
                    d.options.onResize && d.options.onResize(d, j),
                    c ||
                      (d.stop(),
                      d.update(d.options.responsiveAnimationDuration)),
                    d
                  );
                },
                  ...
                  if (
                    (b.each(
                      ...
                      function (b, f) {
                        ...
                        g.type || (g.type = b.type || c.config.type),
                          d.push(g.type),
                          g.controller
                            ? g.controller.updateIndex(f)
                            : ((g.controller = new a.controllers[g.type](c, f)),
                              e.push(g.controller));
                      },
                      c
                    ),
                ...
                update: function (c, d) {
                  var e = this;
                  a.plugins.notify("beforeUpdate", [e]),
                  ...
                  b.each(
                    ...
                    a.layoutService.update(e, e.chart.width, e.chart.height),
                    a.plugins.notify("afterScaleUpdate", [e]),
                    b.each(f, function (a) {
                      a.reset();
                    }),
                    e.updateDatasets(),
                    a.plugins.notify("afterUpdate", [e]),
                    e.render(c, d);
                },
                updateDatasets: function () {
                  ...
                  if (a.plugins.notify("beforeDatasetsUpdate", [d])) {
                    for (b = 0, c = d.data.datasets.length; b < c; ++b)
                      d.getDatasetMeta(b).controller.update();
                ...
                render: function (c, d) {
                  ...
                  if (
                    f &&
                    ((void 0 !== c && 0 !== c) ||
                      (void 0 === c && 0 !== f.duration))
                  ) {
                    var g = new a.Animation();
                    (g.numSteps = (c || f.duration) / 16.66),
                      (g.easing = f.easing),
                      (g.render = function (a, c) {
                        var d = b.easingEffects[c.easing],
                          e = c.currentStep / c.numSteps,
                          f = d(e);
                        a.draw(f, e, c.currentStep);
                      }),
                      (g.onAnimationProgress = f.onProgress),
                      (g.onAnimationComplete = f.onComplete),
                      a.animationService.addAnimation(e, g, c, d);
                  } else
                    e.draw(),
                      f &&
                        f.onComplete &&
                ...
                draw: function (c) {
                  var d = this,
                    e = c || 1;
                  d.clear(),
                    a.plugins.notify("beforeDraw", [d, e]),
                    b.each(
                      d.boxes,
                      function (a) {
                        a.draw(d.chartArea);
                    ...
                    d.scale && d.scale.draw(),
                    a.plugins.notify("beforeDatasetsDraw", [d, e]),
                    b.each(
                      d.data.datasets,
                      function (a, b) {
                        d.isDatasetVisible(b) &&
                          d.getDatasetMeta(b).controller.draw(c);
                      },
                      d,
                      !0
                    ),
                    a.plugins.notify("afterDatasetsDraw", [d, e]),
                    d.tooltip.transition(e).draw(),
                    a.plugins.notify("afterDraw", [d, e]);
                },
                getElementAtEvent: function (a) {
                  var c = this,
                    ...
                    e = [];
                  return (
                    b.each(c.data.datasets, function (a, f) {
                    ...
                    f = function () {
                      if (c.data.datasets)
                        for (var a = 0; a < c.data.datasets.length; a++) {
                          ...
                          if (c.isDatasetVisible(a))
                            for (var e = 0; e < b.data.length; e++)
                              if (b.data[e].inLabelRange(d.x, d.y))
                                return b.data[e];
                        }
                    }.call(c);
                  return f
                ...
                getDatasetAtEvent: function (a) {
                  ...
                  return (
                    b.length > 0 &&
                      (b = this.getDatasetMeta(b[0]._datasetIndex).data),
                    b
                  );
                },
                ...
                getVisibleDatasetCount: function () {
                  for (
                    var a = 0, b = 0, c = this.data.datasets.length;
                    b < c;
                    ++b
                  )
                    this.isDatasetVisible(b) && a++;
                  return a;
                },
                isDatasetVisible: function (a) {
                  var b = this.getDatasetMeta(a);
                  return "boolean" == typeof b.hidden
                    ? !b.hidden
                ...
                destroy: function () {
                  ...
                  c.stop(),
                    c.clear(),
                    b.unbindEvents(c, c.events),
                    b.removeResizeListener(c.chart.canvas.parentNode);
                  var d = c.chart.canvas;
                  (d.width = c.chart.width),
                    (d.height = c.chart.height),
                    void 0 !== c.chart.originalDevicePixelRatio &&
                      c.chart.ctx.scale(
                        1 / c.chart.originalDevicePixelRatio,
                        1 / c.chart.originalDevicePixelRatio
                      ),
                    (d.style.width = c.chart.originalCanvasStyleWidth),
                    (d.style.height = c.chart.originalCanvasStyleHeight),
                    a.plugins.notify("destroy", [c]),
                    delete a.instances[c.id];
                },
                ...
                updateHoverStyle: function (a, b, c) {
                  var d,
                    e,
                    f,
                    g = c ? "setHoverStyle" : "removeHoverStyle";
                  switch (b) {
                    case "single":
                      a = [a[0]];
                      break;
                  ...
                  for (e = 0, f = a.length; e < f; ++e)
                    (d = a[e]) &&
                      this.getDatasetMeta(d._datasetIndex).controller[g](d);
                },
                eventHandler: function (a) {
                  var c = this,
                    ...
                    g = e.tooltips;
                  return (
                    (c.lastActive = c.lastActive || []),
                    (c.lastTooltipActive = c.lastTooltipActive || []),
                    "mouseout" === a.type
                      ? ((c.active = []), (c.tooltipActive = []))
                      : ((c.active = c.getElementsAtEventForMode(a, f.mode)),
                        (c.tooltipActive = c.getElementsAtEventForMode(
                          a,
                          g.mode
                        ))),
                    f.onHover && f.onHover.call(c, c.active),
                    ("mouseup" !== a.type && "click" !== a.type) ||
                      (e.onClick && e.onClick.call(c, a, c.active),
                      c.legend &&
                        c.legend.handleEvent &&
                        c.legend.handleEvent(a)),
                    c.lastActive.length &&
                      c.updateHoverStyle(c.lastActive, f.mode, !1),
                    c.active.length &&
                      f.mode &&
                      c.updateHoverStyle(c.active, f.mode, !0),
                    (g.enabled || g.custom) &&
                      (d.initialize(),
                      (d._active = c.tooltipActive),
                      d.update(!0)),
                    d.pivot(),
                    c.animating ||
                      (b.arrayEquals(c.active, c.lastActive) &&
                        b.arrayEquals(c.tooltipActive, c.lastTooltipActive)) ||
                      (c.stop(),
                      (g.enabled || g.custom) && d.update(!0),
                      c.render(f.animationDuration, !0)),
                    (c.lastActive = c.active),
                    (c.lastTooltipActive = c.tooltipActive),
                    c
                  );
                },
              });
            ...
            (a.DatasetController = function (a, b) {
              ...
              b.extend(a.DatasetController.prototype, {
                ...
                linkScales: function () {
                  ...
                  null === b.xAxisID &&
                    (b.xAxisID =
                      c.xAxisID || a.chart.options.scales.xAxes[0].id),
                    null === b.yAxisID &&
                      (b.yAxisID =
                        c.yAxisID || a.chart.options.scales.yAxes[0].id);
                },
                getDataset: function () {
                ...
                createMetaDataset: function () {
                  ...
                  return (
                    b &&
                    new b({ _chart: a.chart.chart, _datasetIndex: a.index })
                  );
                },
                ...
                removeHoverStyle: function (a, c) {
                  var d = this.chart.data.datasets[a._datasetIndex],
                    ...
                    h = a._model;
                  (h.backgroundColor = f.backgroundColor
                    ? f.backgroundColor
                    : g(d.backgroundColor, e, c.backgroundColor)),
                    (h.borderColor = f.borderColor
                      ? f.borderColor
                      : g(d.borderColor, e, c.borderColor)),
                    (h.borderWidth = f.borderWidth
                      ? f.borderWidth
                      : g(d.borderWidth, e, c.borderWidth));
                },
                setHoverStyle: function (a) {
                  var c = this.chart.data.datasets[a._datasetIndex],
                    d = a._index,
                    ...
                    g = b.getHoverColor,
                    h = a._model;
                  (h.backgroundColor = e.hoverBackgroundColor
                    ? e.hoverBackgroundColor
                    : f(c.hoverBackgroundColor, d, g(h.backgroundColor))),
                    (h.borderColor = e.hoverBorderColor
                      ? e.hoverBorderColor
                      : f(c.hoverBorderColor, d, g(h.borderColor))),
                    (h.borderWidth = e.hoverBorderWidth
                      ? e.hoverBorderWidth
                      : f(c.hoverBorderWidth, d, h.borderWidth));
                },
              }),
            ...
            (a.elements = {}),
              ...
              b.extend(a.Element.prototype, {
                ...
                transition: function (a) {
                  var c = this;
                  return (
                    c._view || (c._view = b.clone(c._model)),
                    1 === a
                      ? ((c._view = c._model), (c._start = null), c)
                      : (c._start || c.pivot(),
                        b.each(
                          c._model,
                          function (d, e) {
                            if ("_" === e[0]);
                              ...
                              "number" != typeof d || isNaN(c._view[e])
                                ? (c._view[e] = d)
                                : (c._view[e] = d * a);
                          },
                          c
        ...
        function (a, b, c) {
          ...
          b.exports = function (a) {
            ...
            function e(a, d, e) {
              ...
              return j || k
                ? Math.min(j ? b(h, a, e) : l, k ? b(i, g, e) : l)
                : "none";
            }
            var f = (a.helpers = {});
            (f.each = function (a, b, c, d) {
              ...
              if (f.isArray(a))
                ...
                else for (e = 0; e < g; e++) b.call(c, a[e], e);
              else if ("object" == typeof a) {
                var h = Object.keys(a);
                ...
                return (
                  f.each(a, function (a, c) {
                    f.isArray(a)
                      ? (b[c] = a.slice(0))
                      : (b[c] =
                          "object" == typeof a && null !== a ? f.clone(a) : a);
                  }),
                  b
                );
              }),
                    ...
                    function (b) {
                      f.each(b, function (b, d) {
                        if ("scales" === d)
                          ...
                          c[d] = f.configMerge(
                            c.hasOwnProperty(d) ? c[d] : {},
                            a.scaleService.getScaleDefaults(b.type),
                            b
                          );
                        else if (
                          c.hasOwnProperty(d) &&
                    ...
                    "xAxes" === c || "yAxes" === c
                      ? d.hasOwnProperty(c)
                        ? f.each(b, function (b, e) {
                            var g = f.getValueOrDefault(
                                b.type,
                                "xAxes" === c ? "category" : "linear"
                              ),
                              h = a.scaleService.getScaleDefaults(g);
                            e >= d[c].length || !d[c][e].type
                              ? d[c].push(f.configMerge(h, b))
                              : b.type && b.type !== d[c][e].type
                              ? (d[c][e] = f.configMerge(d[c][e], h, b))
                              : (d[c][e] = f.configMerge(d[c][e], b));
                          })
                        : ((d[c] = []),
                          f.each(b, function (b) {
              ...
              (f.splineCurve = function (a, b, c, d) {
                var e = a.skip ? b : a,
                  ...
                  g = c.skip ? b : c,
                  h = Math.sqrt(
                    Math.pow(f.x - e.x, 2) + Math.pow(f.y - e.y, 2)
                  ),
                  i = Math.sqrt(
                    Math.pow(g.x - f.x, 2) + Math.pow(g.y - f.y, 2)
                  ),
                  j = h / (h + i),
                  k = i / (h + i);
            ...
            var g = (f.easingEffects = {
              ...
              easeInOutBounce: function (a) {
                return a < 0.5
                  ? 0.5 * g.easeInBounce(2 * a)
                  : 0.5 * g.easeOutBounce(2 * a - 1) + 0.5;
              },
            });
            (f.requestAnimFrame = (function () {
              ...
              (f.getRelativePosition = function (a, b) {
                ...
                return (
                  (c = Math.round(
                    (((c - h.left - j) / n) * g.width) /
                      b.currentDevicePixelRatio
                  )),
                  (d = Math.round(
                    (((d - h.top - k) / o) * g.height) /
                      b.currentDevicePixelRatio
                  )),
                  { x: c, y: d }
                );
              ...
              (f.getMaximumWidth = function (a) {
                var b = a.parentNode,
                  c =
                    parseInt(f.getStyle(b, "padding-left")) +
                    parseInt(f.getStyle(b, "padding-right")),
                  d = b.clientWidth - c,
              ...
              (f.getMaximumHeight = function (a) {
                var b = a.parentNode,
                  c =
                    parseInt(f.getStyle(b, "padding-top")) +
                    parseInt(f.getStyle(b, "padding-bottom")),
                  d = b.clientHeight - c,
              ...
              (f.retinaScale = function (a) {
                var b = a.ctx,
                  ...
                  d = c.width,
                  e = c.height,
                  f = (a.currentDevicePixelRatio =
                    window.devicePixelRatio || 1);
                1 !== f &&
                  ((c.height = e * f),
                  (c.width = d * f),
                  b.scale(f, f),
                  (a.originalDevicePixelRatio =
                    a.originalDevicePixelRatio || f)),
                  (c.style.width = d + "px"),
                  (c.style.height = e + "px");
              }),
              (f.clear = function (a) {
              ...
              (f.longestText = function (a, b, c, d) {
                ...
                var h = 0;
                f.each(c, function (b) {
                  void 0 !== b && null !== b && !0 !== f.isArray(b)
                    ? (h = f.measureText(a, e, g, h, b))
                    : f.isArray(b) &&
                      f.each(b, function (b) {
                        void 0 === b ||
                          null === b ||
              ...
              (f.color = function (b) {
                return d
                  ...
                  : (console.log("Color.js not found!"), b);
              }),
              (f.addResizeListener = function (a, b) {
                var c = document.createElement("iframe");
                c.classlist
                  ? c.classlist.add("chartjs-hidden-iframe")
                  : c.setAttribute("class", "chartjs-hidden-iframe");
                var d = c.style;
                (d.width = "100%"),
                  (d.display = "block"),
                  (d.border = 0),
              ...
              (f.arrayEquals = function (a, b) {
                ...
                for (c = 0, d = a.length; c < d; ++c)
                  if (
                    ((e = a[c]),
                    (g = b[c]),
                    e instanceof Array && g instanceof Array)
                  ) {
              ...
              (f.getHoverColor = function (a) {
                return a instanceof CanvasPattern
                  ? a
                  : f.color(a).saturate(0.5).darken(0.1).rgbString();
              });
          };
        },
        { 2: 2 },
          ...
          b.exports = function () {
            var a = function (b, c) {
              ...
              return (
                ...
                (d.width =
                  b.canvas.width ||
                  parseInt(e.getStyle(b.canvas, "width"), 10) ||
                  e.getMaximumWidth(b.canvas)),
                (d.height =
                  b.canvas.height ||
                  parseInt(e.getStyle(b.canvas, "height"), 10) ||
                  e.getMaximumHeight(b.canvas)),
                (d.aspectRatio = d.width / d.height),
                (isNaN(d.aspectRatio) || !1 === isFinite(d.aspectRatio)) &&
                  (d.aspectRatio =
                    void 0 !== c.aspectRatio ? c.aspectRatio : 2),
                (d.originalCanvasStyleWidth = b.canvas.style.width),
                (d.originalCanvasStyleHeight = b.canvas.style.height),
                e.retinaScale(d),
                (d.controller = new a.Controller(d)),
                e.addResizeListener(b.canvas.parentNode, function () {
                  d.controller &&
                    d.controller.config.options.responsive &&
                    d.controller.resize();
                }),
              ...
              (a.defaults = {
                global: {
                  ...
                  legendCallback: function (a) {
                    var b = [];
                    b.push('<ul class="' + a.id + '-legend">');
                    for (var c = 0; c < a.data.datasets.length; c++)
                      b.push(
                        '<li><span style="background-color:' +
                          a.data.datasets[c].backgroundColor +
                          '"></span>'
                      ),
                        a.data.datasets[c].label &&
                          b.push(a.data.datasets[c].label),
                        b.push("</li>");
                    return b.push("</ul>"), b.join("");
                  },
                },
              ...
              update: function (a, c, d) {
                function e(a) {
                  var b,
                    c = a.isHorizontal();
                  c
                    ? ((b = a.update(a.options.fullWidth ? o : u, t)),
                      (v -= b.height))
                    : ((b = a.update(s, r)), (u -= b.width)),
                    w.push({ horizontal: c, minSize: b, box: a });
                }
                function f(a) {
                ...
                function h(a) {
                  a.isHorizontal()
                    ? ((a.left = a.options.fullWidth ? i : x),
                      (a.right = a.options.fullWidth ? c - i : x + u),
                      (a.top = E),
                      (a.bottom = E + a.height),
                      (E = a.bottom))
                    : ((a.left = D),
                ...
                if (a) {
                  ...
                  b.each(j.concat(l), h),
                    ...
                    b.each(n, function (b) {
                      (b.left = a.chartArea.left),
                        (b.top = a.chartArea.top),
                        (b.right = a.chartArea.right),
                        (b.bottom = a.chartArea.bottom),
                        b.update(u, v);
                    });
                }
              },
          ...
          b.exports = function (a) {
            ...
            (a.defaults.global.legend = {
              ...
              onClick: function (a, b) {
                ...
                (e.hidden =
                  null === e.hidden ? !d.data.datasets[c].hidden : null),
                  d.update();
              },
              labels: {
                boxWidth: 40,
                ...
                generateLabels: function (a) {
                  var c = a.data;
                  return b.isArray(c.datasets)
                    ? c.datasets.map(function (c, d) {
                        return {
                          text: c.label,
                          fillStyle: b.isArray(c.backgroundColor)
                            ? c.backgroundColor[0]
                            : c.backgroundColor,
              ...
              (a.Legend = a.Element.extend({
                ...
                buildLabels: function () {
                  var a = this;
                  (a.legendItems = a.options.labels.generateLabels.call(
                    a,
                    a.chart
                  )),
                    a.options.reverse && a.legendItems.reverse();
                },
                afterBuildLabels: c,
                beforeFit: c,
                fit: function () {
                  ...
                  if (
                    (p
                      ? ((o.width = c.maxWidth), (o.height = f ? 10 : 0))
                      : ((o.width = f ? 10 : 0), (o.height = c.maxHeight)),
                    f)
                  )
                    if (((g.font = m), p)) {
                      ...
                      (g.textAlign = "left"),
                        ...
                        b.each(c.legendItems, function (a, b) {
                          var d = e.usePointStyle
                              ? j * Math.sqrt(2)
                              : e.boxWidth,
                            f = d + j / 2 + g.measureText(a.text).width;
                          q[q.length - 1] + f + e.padding >= c.width &&
                            ((r += j + e.padding), (q[q.length] = c.left)),
                            (n[b] = { left: 0, top: 0, width: f, height: j }),
                      ...
                      b.each(c.legendItems, function (a, b) {
                        ...
                        w + x > o.height &&
                          ((u += v + e.padding), t.push(v), (v = 0), (w = 0)),
                          (v = Math.max(v, d)),
                          (w += x),
                          (n[b] = { left: 0, top: 0, width: d, height: j });
                      }),
                        (u += v),
                        t.push(v),
                        (o.width += u);
                    ...
                    var r = e.boxWidth,
                      ...
                      t = function (b, c, e) {
                        if (!(isNaN(r) || r <= 0)) {
                          if (
                            (k.save(),
                            (k.fillStyle = l(e.fillStyle, f.defaultColor)),
                            (k.lineCap = l(e.lineCap, g.borderCapStyle)),
                            (k.lineDashOffset = l(
                              e.lineDashOffset,
                              g.borderDashOffset
                            )),
                            (k.lineJoin = l(e.lineJoin, g.borderJoinStyle)),
                            (k.lineWidth = l(e.lineWidth, g.borderWidth)),
                            (k.strokeStyle = l(e.strokeStyle, f.defaultColor)),
                            k.setLineDash &&
                              k.setLineDash(l(e.lineDash, g.borderDash)),
                            d.labels && d.labels.usePointStyle)
                          ) {
                            ...
                            k.strokeRect(b, c, r, n), k.fillRect(b, c, r, n);
                          k.restore();
                        }
                      },
                      u = function (a, b, c, d) {
                        k.fillText(c.text, r + n / 2 + a, b),
                          c.hidden &&
                            (k.beginPath(),
                            (k.lineWidth = 2),
                            k.moveTo(r + n / 2 + a, b + n / 2),
                            k.lineTo(r + n / 2 + a + d, b + n / 2),
                            k.stroke());
                      },
                      v = c.isHorizontal();
                    j = v
                    ...
                    b.each(c.legendItems, function (a, b) {
                      ...
                      v
                        ? g + f >= h &&
                          ((l = j.y += w),
                          j.line++,
                          (g = j.x = c.left + (h - i[j.line]) / 2))
                        : l + w > c.bottom &&
                          ((g = j.x = g + c.columnWidths[j.line] + e.padding),
                          (l = j.y = c.top),
                          j.line++),
                        t(g, l, a),
                        (s[b].left = g),
            ...
            (a.plugins = {
              ...
              notify: function (a, b) {
                ...
                for (c = 0; c < f; ++c)
                  if (
                    ((d = e[c]),
                    "function" == typeof d[a] && !1 === d[a].apply(d, b || []))
                  )
                    return !1;
                return !0;
              },
              ...
              (a.Scale = a.Element.extend({
                ...
                update: function (a, c, d) {
                  ...
                  return (
                    ...
                    e.beforeSetDimensions(),
                    e.setDimensions(),
                    e.afterSetDimensions(),
                    e.beforeDataLimits(),
                    e.determineDataLimits(),
                    e.afterDataLimits(),
                    e.beforeBuildTicks(),
                    e.buildTicks(),
                    e.afterBuildTicks(),
                    e.beforeTickToLabelConversion(),
                    e.convertTicksToLabels(),
                    e.afterTickToLabelConversion(),
                    e.beforeCalculateTickRotation(),
                    e.calculateTickRotation(),
                    e.afterCalculateTickRotation(),
                    e.beforeFit(),
                    e.fit(),
                    e.afterFit(),
                    e.afterUpdate(),
                ...
                beforeTickToLabelConversion: function () {
                  b.callCallback(this.options.beforeTickToLabelConversion, [
                    this,
                  ]);
                },
                convertTicksToLabels: function () {
                  ...
                  a.ticks = a.ticks.map(function (b, c, d) {
                    return a.options.ticks.userCallback
                      ? a.options.ticks.userCallback(b, c, d)
                      : a.options.ticks.callback(b, c, d);
                  }, a);
                },
                afterTickToLabelConversion: function () {
                  b.callCallback(this.options.afterTickToLabelConversion, [
                    this,
                  ]);
                },
                beforeCalculateTickRotation: function () {
                  b.callCallback(this.options.beforeCalculateTickRotation, [
                    this,
                  ]);
                },
                calculateTickRotation: function () {
                  ...
                  d.font = j;
                  var k,
                    l = d.measureText(c.ticks[0]).width,
                    m = d.measureText(c.ticks[c.ticks.length - 1]).width;
                  if (
                    ((c.labelRotation = f.minRotation || 0),
                    (c.paddingRight = 0),
                    (c.paddingLeft = 0),
                    c.options.display && c.isHorizontal())
                  ) {
                    (c.paddingRight = m / 2 + 3),
                      (c.paddingLeft = l / 2 + 3),
                      c.longestTextCache || (c.longestTextCache = {});
                    for (
                      var n,
                        o,
                        p = b.longestText(d, j, c.ticks, c.longestTextCache),
                        q = p,
                        r = c.getPixelForTick(1) - c.getPixelForTick(0) - 6;
                      q > r && c.labelRotation < f.maxRotation;

                    ) {
                      if (
                        ((n = Math.cos(b.toRadians(c.labelRotation))),
                        (o = Math.sin(b.toRadians(c.labelRotation))),
                        (k = n * l),
                        k + g / 2 > c.yLabelWidth &&
                          (c.paddingLeft = k + g / 2),
                        (c.paddingRight = g / 2),
                  ...
                  c.margins &&
                    ((c.paddingLeft = Math.max(
                      c.paddingLeft - c.margins.left,
                      0
                    )),
                    (c.paddingRight = Math.max(
                      c.paddingRight - c.margins.right,
                      0
                    )));
                },
                afterCalculateTickRotation: function () {
                  b.callCallback(this.options.afterCalculateTickRotation, [
                    this,
                  ]);
                },
                beforeFit: function () {
                ...
                fit: function () {
                  ...
                  if (
                    ((d.width = j
                      ? c.isFullWidth()
                        ? c.maxWidth - c.margins.left - c.margins.right
                        : c.maxWidth
                      : i
                      ? p
                      : 0),
                    (d.height = j ? (i ? p : 0) : c.maxHeight),
                    h.display &&
                      i &&
                      (j ? (d.height += 1.5 * o) : (d.width += 1.5 * o)),
                    g.display && i)
                  ) {
                    c.longestTextCache || (c.longestTextCache = {});
                    var q = b.longestText(
                    ...
                    if (j) {
                      ...
                      var t =
                        Math.sin(b.toRadians(c.labelRotation)) *
                          c.longestLabelWidth +
                        k * r +
                        s * r;
                      (d.height = Math.min(c.maxHeight, d.height + t)),
                        (c.ctx.font = n);
                      var u = c.ctx.measureText(c.ticks[0]).width,
                        v = c.ctx.measureText(
                          c.ticks[c.ticks.length - 1]
                        ).width,
                        w = Math.cos(b.toRadians(c.labelRotation)),
                        x = Math.sin(b.toRadians(c.labelRotation));
                      (c.paddingLeft =
                        0 !== c.labelRotation ? w * u + 3 : u / 2 + 3),
                        (c.paddingRight =
                          0 !== c.labelRotation ? x * (k / 2) + 3 : v / 2 + 3);
                    } else {
                      var y = c.maxWidth - d.width;
                      g.mirror ? (q = 0) : (q += c.options.ticks.padding),
                        q < y ? (d.width += q) : (d.width = c.maxWidth),
                        (c.paddingTop = k / 2),
                        (c.paddingBottom = k / 2);
                    }
                  }
                  c.margins &&
                    ...
                    (c.paddingBottom = Math.max(
                      c.paddingBottom - c.margins.bottom,
                      0
                    ))),
                    (c.width = d.width),
                    (c.height = d.height);
                  ...
                  if (c.isHorizontal()) {
                    var d = c.width - (c.paddingLeft + c.paddingRight),
                      e =
                        ...
                        Math.max(
                          c.ticks.length -
                            (c.options.gridLines.offsetGridLines ? 0 : 1),
                          1
                        ),
                      f = e * a + c.paddingLeft;
                    b && (f += e / 2);
                  ...
                  if (e.display) {
                    ...
                    if (o) {
                      if (
                        ((f = !1),
                        m && (C /= 2),
                        (C + j.autoSkipPadding) * d.ticks.length >
                    ...
                    if (
                      (b.each(d.ticks, function (a, g) {
                        if (void 0 !== a && null !== a) {
                          var h = d.ticks.length === g + 1;
                          if (
                            (!(
                              (f > 1 && g % f > 0) ||
                              (g % f == 0 && g + f >= d.ticks.length)
                            ) ||
                              h) &&
                            void 0 !== a &&
                            null !== a
                            ...
                            var i, l;
                            g ===
                            (void 0 !== d.zeroLineIndex ? d.zeroLineIndex : 0)
                              ? ((i = k.zeroLineWidth), (l = k.zeroLineColor))
                              : ((i = b.getValueAtIndexOrDefault(
                                  k.lineWidth,
                                  g
                                )),
                                (l = b.getValueAtIndexOrDefault(k.color, g)));
                            var n,
                              p,
                              q,
                              r,
                            ...
                            if (o) {
                              m ||
                                (B = "top" === e.position ? "bottom" : "top"),
                                (z = m ? "right" : "center");
                              var C = d.getPixelForTick(g) + b.aliasPixel(i);
                              (x =
                                d.getPixelForTick(g, k.offsetGridLines) +
                                j.labelOffset),
                                (y = m
                                  ? d.top + 12
                                  : "top" === e.position
                              ...
                              "left" === e.position
                                ? j.mirror
                                  ? ((x = d.right + j.padding), (z = "left"))
                                  : ((x = d.right - j.padding), (z = "right"))
                                : j.mirror
                                ? ((x = d.left - j.padding), (z = "right"))
                                : ((x = d.left + j.padding), (z = "left"));
                              var I = d.getPixelForTick(g);
                              (I += b.aliasPixel(i)),
                                (y = d.getPixelForTick(g, k.offsetGridLines)),
                                (n = E),
                                (q = F),
                                (s = c.left),
                                (v = c.right),
                      ...
                      b.each(D, function (a) {
                        if (
                          (k.display &&
                            ((h.lineWidth = a.glWidth),
                            (h.strokeStyle = a.glColor),
                            h.beginPath(),
                            k.drawTicks &&
                              (h.moveTo(a.tx1, a.ty1), h.lineTo(a.tx2, a.ty2)),
                            k.drawOnChartArea &&
                              (h.moveTo(a.x1, a.y1), h.lineTo(a.x2, a.y2)),
                            h.stroke()),
                          j.display)
                        ) {
                          h.save(),
                            h.translate(a.labelX, a.labelY),
                            h.rotate(a.rotation),
                            (h.font = t),
                            (h.textBaseline = a.textBaseline),
                            (h.textAlign = a.textAlign);
                          var c = a.label;
                          if (b.isArray(c))
                            for (var d = 0, e = 0; d < c.length; ++d)
                              h.fillText("" + c[d], 0, e), (e += 1.5 * q);
                      ...
                      if (o)
                        ...
                        (I = L ? d.left + w / 2 : d.right - w / 2),
                          (J = d.top + (d.bottom - d.top) / 2),
                          (K = L ? -0.5 * Math.PI : 0.5 * Math.PI);
                      }
                      h.save(),
                        h.translate(I, J),
                        h.rotate(K),
                        ...
                        (h.fillStyle = v),
                        (h.font = z),
                        h.fillText(l.labelString, 0, 0),
                        h.restore();
                    }
                    if (k.drawBorder) {
                      (h.lineWidth = b.getValueAtIndexOrDefault(
                        k.lineWidth,
                        0
                      )),
                        (h.strokeStyle = b.getValueAtIndexOrDefault(
                          k.color,
                          0
                        ));
                      var M = d.left,
                      ...
                      o
                        ? ((O = P = "top" === e.position ? d.bottom : d.top),
                          (O += Q),
                          (P += Q))
                        : ((M = N = "left" === e.position ? d.right : d.left),
                          (M += Q),
                          (N += Q)),
                        h.beginPath(),
                        h.moveTo(M, O),
          ...
          b.exports = function (a) {
            ...
            a.scaleService = {
              ...
              getScaleConstructor: function (a) {
                return this.constructors.hasOwnProperty(a)
                  ? this.constructors[a]
                  : void 0;
              },
              getScaleDefaults: function (c) {
                return this.defaults.hasOwnProperty(c)
                  ? b.scaleMerge(a.defaults.scale, this.defaults[c])
                  : {};
              },
          ...
          b.exports = function (a) {
            ...
            (a.Title = a.Element.extend({
              ...
              setDimensions: function () {
                var a = this;
                a.isHorizontal()
                  ? ((a.width = a.maxWidth), (a.left = 0), (a.right = a.width))
                  : ((a.height = a.maxHeight),
                    (a.top = 0),
                    (a.bottom = a.height)),
                  (a.paddingLeft = 0),
              ...
              fit: function () {
                ...
                c.isHorizontal()
                  ? ((i.width = c.maxWidth),
                    (i.height = g ? h + 2 * e.padding : 0))
                  : ((i.width = g ? h + 2 * e.padding : 0),
                    (i.height = c.maxHeight)),
                  (c.width = i.width),
                  (c.height = i.height);
              },
              afterFit: c,
              ...
              draw: function () {
                ...
                if (f.display) {
                  var h,
                    i,
                    j = e(f.fontSize, g.defaultFontSize),
                    ...
                    q = c.bottom,
                    r = c.right;
                  (d.fillStyle = e(f.fontColor, g.defaultFontColor)),
                    (d.font = m),
                    c.isHorizontal()
                      ? ((h = p + (r - p) / 2), (i = o + (q - o) / 2))
                      : ((h = "left" === f.position ? p + j / 2 : r - j / 2),
                        (i = o + (q - o) / 2),
                        (n = Math.PI * ("left" === f.position ? -0.5 : 0.5))),
                    d.save(),
                    d.translate(h, i),
                    d.rotate(n),
                    (d.textAlign = "center"),
                    (d.textBaseline = "middle"),
                    d.fillText(f.text, 0, 0),
                    d.restore();
                }
              },
            })),
        ...
        function (a, b, c) {
          ...
          b.exports = function (a) {
            function b(a, b) {
              return (
                b &&
                  (e.isArray(b) ? Array.prototype.push.apply(a, b) : a.push(b)),
                a
              );
            }
            function c(a) {
            ...
            (a.defaults.global.tooltips = {
              ...
              callbacks: {
                ...
                label: function (a, b) {
                  return (
                    (b.datasets[a.datasetIndex].label || "") + ": " + a.yLabel
                  );
                },
              ...
              (a.Tooltip = a.Element.extend({
                ...
                getBody: function (a, c) {
                  ...
                  return (
                    e.each(a, function (a) {
                      ...
                      b(e.before, f.beforeLabel.call(d, a, c)),
                        b(e.lines, f.label.call(d, a, c)),
                        b(e.after, f.afterLabel.call(d, a, c)),
                        g.push(e);
                    }),
                    g
                  );
                ...
                update: function (a) {
                  ...
                  if (j.length) {
                    ...
                    h.itemSort && (o = o.sort(h.itemSort)),
                      j.length > 1 &&
                        e.each(o, function (a) {
                    ...
                    g.determineAlignment(p),
                      e.extend(i, g.getBackgroundPoint(i, p));
                  } else g._model.opacity = 0;
                  return a && h.custom && h.custom.call(g, i), g;
                },
                getTooltipSize: function (a) {
                  var b = this._chart.ctx,
                    c = { height: 2 * a.yPadding, width: 0 },
                    d = a.body,
                    f = d.reduce(function (a, b) {
                      return (
                        a + b.before.length + b.lines.length + b.after.length
                      );
                    }, 0);
                  ...
                  var g = a.title.length,
                    ...
                    k = a.footerFontSize;
                  (c.height += g * i),
                    (c.height += (g - 1) * a.titleSpacing),
                    (c.height += g ? a.titleMarginBottom : 0),
                    (c.height += f * j),
                    (c.height += f ? (f - 1) * a.bodySpacing : 0),
                    (c.height += h ? a.footerMarginTop : 0),
                    (c.height += h * k),
                    (c.height += h ? (h - 1) * a.footerSpacing : 0);
                  var l = 0,
                    m = function (a) {
                  ...
                  return (
                    ...
                    e.each(a.beforeBody.concat(a.afterBody), m),
                    (l = d.length > 1 ? j + 2 : 0),
                    e.each(d, function (a) {
                      e.each(a.before, m),
                        e.each(a.lines, m),
                ...
                determineAlignment: function (a) {
                  ...
                  c.y < a.height
                    ? (c.yAlign = "top")
                    : c.y > d.height - a.height && (c.yAlign = "bottom");
                  var f,
                    g,
                    h,
                    i,
                  ...
                  "center" === c.yAlign
                    ...
                    f(c.x)
                      ? ((c.xAlign = "left"),
                        h(c.x) && ((c.xAlign = "center"), (c.yAlign = j(c.y))))
                      : g(c.x) &&
                        ((c.xAlign = "right"),
                        i(c.x) && ((c.xAlign = "center"), (c.yAlign = j(c.y))));
                },
                getBackgroundPoint: function (a, b) {
                  ...
                  return (
                    "right" === g
                      ? (c.x -= b.width)
                      : "center" === g && (c.x -= b.width / 2),
                    "top" === h
                      ? (c.y += i)
                      : (c.y -= "bottom" === h ? b.height + i : b.height / 2),
                    "center" === h
                      ? "left" === g
                        ? (c.x += i)
                        : "right" === g && (c.x -= i)
                ...
                drawCaret: function (a, b, c) {
                  ...
                  (l.fillStyle = u.alpha(c * u.alpha()).rgbString()),
                    l.beginPath(),
                    l.moveTo(d, h),
                    l.lineTo(f, i),
                    l.lineTo(g, j),
                ...
                drawTitle: function (a, b, c, d) {
                  ...
                  if (f.length) {
                    ...
                    (c.fillStyle = i.alpha(d * i.alpha()).rgbString()),
                      (c.font = e.fontString(
                        g,
                        b._titleFontStyle,
                        b._titleFontFamily
                    ...
                    for (j = 0, k = f.length; j < k; ++j)
                      c.fillText(f[j], a.x, a.y),
                        (a.y += g + h),
                        j + 1 === f.length && (a.y += b.titleMarginBottom - h);
                  }
                },
                drawBody: function (a, b, c, d) {
                  ...
                  var m = h.length > 1;
                  (k = m ? f + 2 : 0),
                    e.each(h, function (g, h) {
                      e.each(g.before, l),
                        e.each(g.lines, function (g) {
                          m &&
                            ((c.fillStyle = e
                              .color(b.legendColorBackground)
                              .alpha(d)
                              .rgbaString()),
                            c.fillRect(a.x, a.y, f, f),
                            (c.strokeStyle = e
                              .color(b.labelColors[h].borderColor)
                              .alpha(d)
                              .rgbaString()),
                            c.strokeRect(a.x, a.y, f, f),
                            (c.fillStyle = e
                              .color(b.labelColors[h].backgroundColor)
                              .alpha(d)
                              .rgbaString()),
                            c.fillRect(a.x + 1, a.y + 1, f - 2, f - 2),
                            (c.fillStyle = j)),
                            l(g);
                        }),
                        e.each(g.after, l);
                ...
                drawFooter: function (a, b, c, d) {
                  ...
                  if (f.length) {
                    (a.y += b.footerMarginTop),
                      (c.textAlign = b._footerAlign),
                      (c.textBaseline = "top");
                    var g = e.color(b.footerFontColor);
                    (c.fillStyle = g.alpha(d * g.alpha()).rgbString()),
                      (c.font = e.fontString(
                        b.footerFontSize,
                        b._footerFontStyle,
                        b._footerFontFamily
                      ...
                      e.each(f, function (d) {
                        c.fillText(d, a.x, a.y),
                          (a.y += b.footerFontSize + b.footerSpacing);
                      });
                  }
                },
                draw: function () {
                  ...
                  if (0 !== b.opacity) {
                    var c = this.getTooltipSize(b),
                      d = { x: b.x, y: b.y },
                      f = Math.abs(b.opacity < 0.001) ? 0 : b.opacity;
                    if (this._options.enabled) {
                      var g = e.color(b.backgroundColor);
                      (a.fillStyle = g.alpha(f * g.alpha()).rgbString()),
                        e.drawRoundedRectangle(
                          a,
                          d.x,
                          d.y,
                          c.width,
                        ...
                        a.fill(),
                        this.drawCaret(d, c, f),
                        (d.x += b.xPadding),
                        (d.y += b.yPadding),
                        this.drawTitle(d, b, a, f),
                        this.drawBody(d, b, a, f),
                        this.drawFooter(d, b, a, f);
                    }
                  }
                },
              }));
            ...
            (c.elements.arc = {
              ...
              (a.elements.Arc = a.Element.extend({
                inLabelRange: function (a) {
                  ...
                  return (
                    !!b &&
                    Math.pow(a - b.x, 2) < Math.pow(b.radius + b.hoverRadius, 2)
                  );
                },
                inRange: function (a, c) {
                  ...
                  if (d) {
                    for (
                      var e = b.getAngleFromPoint(d, { x: a, y: c }),
                        f = e.angle,
                        g = e.distance,
                        h = d.startAngle,
                        i = d.endAngle;
                ...
                draw: function () {
                  var a = this._chart.ctx,
                    ...
                    d = b.endAngle;
                  a.beginPath(),
                    a.arc(b.x, b.y, b.outerRadius, c, d),
                    a.arc(b.x, b.y, b.innerRadius, d, c, !0),
                    a.closePath(),
            ...
            (a.defaults.global.elements.line = {
              ...
              (a.elements.Line = a.Element.extend({
                draw: function () {
                  function a(a, b) {
                    var c = b._view;
                    !0 === b._view.steppedLine
                      ? (i.lineTo(b._view.x, a._view.y),
                        i.lineTo(b._view.x, b._view.y))
                      : 0 === b._view.tension
                      ? i.lineTo(c.x, c.y)
                      : i.bezierCurveTo(
                          a._view.controlPointNextX,
                          a._view.controlPointNextY,
                          c.controlPointPreviousX,
                          c.controlPointPreviousY,
                          c.x,
                          c.y
                        );
                  }
                  ...
                  var l, m, n, o;
                  if (j.length && e.fill) {
                    for (i.beginPath(), l = 0; l < j.length; ++l)
                      (m = j[l]),
                        (n = b.previousItem(j, l)),
                        (o = m._view),
                        0 === l
                          ? (h ? i.moveTo(g.x, g.y) : i.moveTo(o.x, g),
                            o.skip || ((k = l), i.lineTo(o.x, o.y)))
                          : ((n = -1 === k ? n : j[k]),
                            o.skip
                              ? f ||
                                k !== l - 1 ||
                                (h
                                  ? i.lineTo(g.x, g.y)
                                  : i.lineTo(n._view.x, g))
                              : (k !== l - 1
                                  ? f && -1 !== k
                                    ? a(n, m)
                                    : h
                                    ? i.lineTo(o.x, o.y)
                                    : (i.lineTo(o.x, g), i.lineTo(o.x, o.y))
                                  : a(n, m),
                                (k = l)));
                    h || i.lineTo(j[k]._view.x, g),
                      (i.fillStyle = e.backgroundColor || c.defaultColor),
                      i.closePath(),
                      i.fill();
                  }
                  var p = c.elements.line;
                  for (
                    i.lineCap = e.borderCapStyle || p.borderCapStyle,
                      i.setLineDash &&
                        i.setLineDash(e.borderDash || p.borderDash),
                      i.lineDashOffset =
                        e.borderDashOffset || p.borderDashOffset,
                      i.lineJoin = e.borderJoinStyle || p.borderJoinStyle,
                      i.lineWidth = e.borderWidth || p.borderWidth,
                      i.strokeStyle = e.borderColor || c.defaultColor,
                      i.beginPath(),
                      k = -1,
                      l = 0;
                    l < j.length;
            ...
            (c.elements.point = {
              ...
              (a.elements.Point = a.Element.extend({
                inRange: function (a, b) {
                  ...
                  return (
                    !!c &&
                    Math.pow(a - c.x, 2) + Math.pow(b - c.y, 2) <
                ...
                inLabelRange: function (a) {
                  ...
                  return (
                    !!b &&
                    Math.pow(a - b.x, 2) < Math.pow(b.radius + b.hitRadius, 2)
                  );
                },
                tooltipPosition: function () {
                  var a = this._view;
                ...
                draw: function () {
                  var e = this._view,
                    ...
                    j = e.y;
                  e.skip ||
                    ((f.strokeStyle = e.borderColor || d),
                    (f.lineWidth = b.getValueOrDefault(
                      e.borderWidth,
                      c.elements.point.borderWidth
                    )),
                    (f.fillStyle = e.backgroundColor || d),
                    a.canvasHelpers.drawPoint(f, g, h, i, j));
                },
              }));
          };
        },
            ...
            (b.elements.rectangle = {
              ...
              (a.elements.Rectangle = a.Element.extend({
                ...
                inLabelRange: function (a) {
                  var b = this._view;
                  return (
                    !!b && a >= b.x - b.width / 2 && a <= b.x + b.width / 2
                  );
                },
                tooltipPosition: function () {
                  var a = this._view;
            ...
            var b = a.helpers,
              ...
              d = a.Scale.extend({
                getLabels: function () {
                  ...
                  return (
                    (this.isHorizontal() ? a.xLabels : a.yLabels) || a.labels
                  );
                },
                determineDataLimits: function () {
                  ...
                  var d;
                  void 0 !== a.options.ticks.min &&
                    ((d = b.indexOf(c, a.options.ticks.min)),
                    (a.minIndex = -1 !== d ? d : a.minIndex)),
                    void 0 !== a.options.ticks.max &&
                      ((d = b.indexOf(c, a.options.ticks.max)),
                      (a.maxIndex = -1 !== d ? d : a.maxIndex)),
                    (a.min = c[a.minIndex]),
                    (a.max = c[a.maxIndex]);
                },
                buildTicks: function () {
                  var a = this,
                    b = a.getLabels();
                  a.ticks =
                    0 === a.minIndex && a.maxIndex === b.length - 1
                      ? b
                      : b.slice(a.minIndex, a.maxIndex + 1);
                },
                ...
                getPixelForValue: function (a, b, c, d) {
                  ...
                  if (e.isHorizontal()) {
                    ...
                    return (
                      e.options.gridLines.offsetGridLines && d && (k += j / 2),
                      e.left + Math.round(k)
                    );
                  }
                  ...
                  return (
                    e.options.gridLines.offsetGridLines && d && (n += m / 2),
                    e.top + Math.round(n)
                  );
                },
                getPixelForTick: function (a, b) {
                ...
                getValueForPixel: function (a) {
                  var b = this,
                    c = Math.max(
                      b.ticks.length -
                        (b.options.gridLines.offsetGridLines ? 0 : 1),
                      1
                    ),
                    d = b.isHorizontal(),
                    e = d
                  ...
                  return (
                    (a -= d ? b.left : b.top),
                    b.options.gridLines.offsetGridLines && (a -= f / 2),
                    (a -= d ? b.paddingLeft : b.paddingTop),
                    a <= 0 ? 0 : Math.round(a / f)
                  );
                },
                getBasePixel: function () {
                  return this.bottom;
              ...
              d = a.LinearScaleBase.extend({
                    ...
                    b.each(g, function (f, g) {
                      ...
                      b.each(i, function (a) {
                        ...
                        (c.min = null === c.min ? e : Math.min(c.min, e)),
                          (c.max = null === c.max ? f : Math.max(c.max, f));
                      });
                  } else
                    b.each(g, function (d, f) {
                      var g = e.getDatasetMeta(f);
                      e.isDatasetVisible(f) &&
                        a(g) &&
                ...
                getTickLimit: function () {
                  ...
                  if (d.isHorizontal())
                    c = Math.min(
                      ...
                      Math.ceil(d.width / 50)
                    );
                  else {
                    var f = b.getValueOrDefault(
                      e.fontSize,
                      a.defaults.global.defaultFontSize
                    );
                    c = Math.min(
                      e.maxTicksLimit ? e.maxTicksLimit : 11,
                      Math.ceil(d.height / (2 * f))
                    );
                  }
                  return c;
                },
                ...
                getLabelForIndex: function (a, b) {
                  return +this.getRightValue(
                    this.chart.data.datasets[b].data[a]
                  );
                },
                getPixelForValue: function (a) {
                  ...
                  return d.isHorizontal()
                    ? ((c = d.width - (e + d.paddingRight)),
                      (b = d.left + (c / i) * (h - g)),
                      Math.round(b + e))
                    : ((c = d.height - (d.paddingTop + f)),
                      (b = d.bottom - f - (c / i) * (h - g)),
                      Math.round(b));
                },
                getValueForPixel: function (a) {
                  var b = this,
                    ...
                    e = b.paddingBottom,
                    f = c
                      ? b.width - (d + b.paddingRight)
                      : b.height - (b.paddingTop + e),
          ...
          b.exports = function (a) {
            ...
            a.LinearScaleBase = a.Scale.extend({
                ...
                void 0 !== d.min
                  ...
                  void 0 !== d.max
                    ...
                    : void 0 !== d.suggestedMax &&
                      (a.max = Math.max(a.max, d.suggestedMax)),
                  a.min === a.max && (a.max++, d.beginAtZero || a.min--);
              },
              getTickLimit: c,
              ...
              buildTicks: function () {
                ...
                var h;
                if (
                  (e.fixedStepSize && e.fixedStepSize > 0) ||
                  (e.stepSize && e.stepSize > 0)
                )
                  h = f(e.fixedStepSize, e.stepSize);
                else {
                ...
                var j = Math.floor(a.min / h) * h,
                  ...
                  l = (k - j) / h;
                (l = b.almostEquals(l, Math.round(l), h / 1e3)
                  ? Math.round(l)
                  : Math.ceil(l)),
                  d.push(void 0 !== e.min ? e.min : j);
                for (var m = 1; m < l; ++m) d.push(j + m * h);
                d.push(void 0 !== e.max ? e.max : k),
                  a.handleDirectionalChanges(),
                  (a.max = b.max(d)),
                  (a.min = b.min(d)),
                  e.reverse
                    ? (d.reverse(), (a.start = a.max), (a.end = a.min))
                    : ((a.start = a.min), (a.end = a.max));
              },
              convertTicksToLabels: function () {
                var b = this;
                (b.ticksAsNumbers = b.ticks.slice()),
                  (b.zeroLineIndex = b.ticks.indexOf(0)),
                  a.Scale.prototype.convertTicksToLabels.call(b);
              },
            });
          };
        },
                ...
                determineDataLimits: function () {
                  ...
                  if (((c.min = null), (c.max = null), d.stacked)) {
                    ...
                    b.each(h, function (e, g) {
                      ...
                      f.isDatasetVisible(g) &&
                        a(h) &&
                        (void 0 === k[h.type] && (k[h.type] = []),
                        b.each(e.data, function (a, b) {
                          var e = k[h.type],
                            f = +c.getRightValue(a);
                          isNaN(f) ||
                            h.data[b].hidden ||
                            ((e[b] = e[b] || 0),
                            d.relativePoints ? (e[b] = 100) : (e[b] += f));
                        }));
                    }),
                      b.each(k, function (a) {
                        var d = b.min(a),
                          e = b.max(a);
                        (c.min = null === c.min ? d : Math.min(c.min, d)),
                  ...
                  (c.min = i(e.min, c.min)),
                    ...
                    c.min === c.max &&
                      (0 !== c.min && null !== c.min
                        ? ((c.min = Math.pow(
                            10,
                            Math.floor(b.log10(c.min)) - 1
                          )),
                          (c.max = Math.pow(
                            10,
                            Math.floor(b.log10(c.max)) + 1
                          )))
                        : ((c.min = 1), (c.max = 10)));
                },
                buildTicks: function () {
                  for (
                    var a = this,
                      ...
                      e = b.getValueOrDefault,
                      f = (a.ticks = []),
                      g = e(d.min, Math.pow(10, Math.floor(b.log10(a.min))));
                    g < a.max;
                  ...
                  var j = e(d.max, g);
                  f.push(j),
                    a.isHorizontal() || f.reverse(),
                    (a.max = b.max(f)),
                    (a.min = b.min(f)),
                    d.reverse
                      ? (f.reverse(), (a.start = a.max), (a.end = a.min))
                      : ((a.start = a.min), (a.end = a.max));
                },
                convertTicksToLabels: function () {
                  (this.tickValues = this.ticks.slice()),
                    a.Scale.prototype.convertTicksToLabels.call(this);
                },
                getLabelForIndex: function (a, b) {
                  return +this.getRightValue(
                    this.chart.data.datasets[b].data[a]
                ...
                getPixelForValue: function (a) {
                  ...
                  return (
                    e.isHorizontal()
                      ? 0 === g
                        ? (d = e.left + k)
                        : ((c = e.width - (k + e.paddingRight)),
                          (d = e.left + (c / h) * (b.log10(g) - b.log10(f))),
                          (d += k))
                      : 0 === g
                      ? (d = e.top + i)
                      : ((c = e.height - (i + j)),
                        (d =
                          e.bottom - j - (c / h) * (b.log10(g) - b.log10(f)))),
                    d
                  );
                },
                getValueForPixel: function (a) {
                  ...
                  return (
                    e.isHorizontal()
                      ? ((d = e.width - (e.paddingLeft + e.paddingRight)),
                        (c =
                          e.start *
                          Math.pow(10, ((a - e.left - e.paddingLeft) * f) / d)))
                      : ((d = e.height - (e.paddingTop + e.paddingBottom)),
                        (c =
                          Math.pow(
                            10,
                            ((e.bottom - e.paddingBottom - a) * f) / d
                          ) / e.start)),
                    c
                  );
                },
            ...
            var b = a.helpers,
              ...
              e = a.LinearScaleBase.extend({
                ...
                setDimensions: function () {
                  ...
                  (a.width = a.maxWidth),
                    (a.height = a.maxHeight),
                    (a.xCenter = Math.round(a.width / 2)),
                    (a.yCenter = Math.round(a.height / 2));
                  var f = b.min([a.height, a.width]),
                    g = b.getValueOrDefault(e.fontSize, c.defaultFontSize);
                  a.drawingArea = d.display
                    ? f / 2 - (g / 2 + e.backdropPaddingY)
                    : f / 2;
                },
                determineDataLimits: function () {
                  var a = this,
                  ...
                  (a.min = null),
                    (a.max = null),
                    b.each(c.data.datasets, function (d, e) {
                ...
                getTickLimit: function () {
                  ...
                  return Math.min(
                    ...
                    Math.ceil(this.drawingArea / (1.5 * d))
                  );
                },
                convertTicksToLabels: function () {
                  var b = this;
                  a.LinearScaleBase.prototype.convertTicksToLabels.call(b),
                    (b.pointLabels = b.chart.data.labels.map(
                      b.options.pointLabels.callback,
                      b
                    ));
                },
                getLabelForIndex: function (a, b) {
                ...
                fit: function () {
                  ...
                  for (
                    this.ctx.font = s, d = 0;
                    d < this.getValueCount();
                    d++
                  ) {
                    (a = this.getPointPosition(d, t)),
                      (e =
                        this.ctx.measureText(
                          this.pointLabels[d] ? this.pointLabels[d] : ""
                        ).width + 5);
                  ...
                  (k = v),
                    (l = Math.ceil(u - this.width)),
                    (h = this.getIndexAngle(g)),
                    (j = this.getIndexAngle(i)),
                    (m = l / Math.sin(h + Math.PI / 2)),
                    (n = k / Math.sin(j + Math.PI / 2)),
                    (m = b.isNumber(m) ? m : 0),
                    (n = b.isNumber(n) ? n : 0),
                    (this.drawingArea = Math.round(t - (n + m) / 2)),
                    this.setCenterPoint(n, m);
                },
                setCenterPoint: function (a, b) {
                  var c = this,
                    d = c.width - b - c.drawingArea,
                    e = a + c.drawingArea;
                  (c.xCenter = Math.round((e + d) / 2 + c.left)),
                    (c.yCenter = Math.round(c.height / 2 + c.top));
                },
                ...
                getPointPositionForValue: function (a, b) {
                  return this.getPointPosition(
                    a,
                    this.getDistanceFromCenterForValue(b)
                  );
                },
                getBasePosition: function () {
                  var a = this,
                    b = a.min,
                    c = a.max;
                  return a.getPointPositionForValue(
                    0,
                    a.beginAtZero
                      ? 0
                      : b < 0 && c < 0
                ...
                draw: function () {
                  ...
                  if (d.display) {
                    var j = a.ctx,
                      ...
                      n = b.fontString(k, l, m);
                    if (
                      (b.each(a.ticks, function (g, h) {
                        if (h > 0 || d.reverse) {
                          var l = a.getDistanceFromCenterForValue(
                              a.ticksAsNumbers[h]
                            ),
                            m = a.yCenter - l;
                          if (e.display && 0 !== h)
                            if (
                              ((j.strokeStyle = b.getValueAtIndexOrDefault(
                                e.color,
                                h - 1
                              )),
                              (j.lineWidth = b.getValueAtIndexOrDefault(
                                e.lineWidth,
                                h - 1
                              )),
                              d.lineArc)
                              ...
                              j.beginPath(),
                                j.arc(a.xCenter, a.yCenter, l, 0, 2 * Math.PI),
                                j.closePath(),
                                j.stroke();
                            else {
                              j.beginPath();
                          ...
                          if (f.display) {
                            ...
                            if (((j.font = n), f.showLabelBackdrop)) {
                              ...
                              (j.fillStyle = f.backdropColor),
                                j.fillRect(
                                  a.xCenter - r / 2 - f.backdropPaddingX,
                                  m - k / 2 - f.backdropPaddingY,
                                  r + 2 * f.backdropPaddingX,
                                  k + 2 * f.backdropPaddingY
                                );
                            }
                            (j.textAlign = "center"),
                      ...
                      for (
                        var o = a.getDistanceFromCenterForValue(
                            d.reverse ? a.min : a.max
                          ),
                          p = i(h.fontSize, c.defaultFontSize),
                          q = i(h.fontStyle, c.defaultFontStyle),
                          r = i(h.fontFamily, c.defaultFontFamily),
                          s = b.fontString(p, q, r),
                          t = a.getValueCount() - 1;
                        t >= 0;
                        t--
              ...
              var b = a.helpers,
                ...
                f = a.Scale.extend({
                  ...
                  getLabelMoment: function (a, b) {
                    return void 0 !== this.labelMoments[a]
                      ? this.labelMoments[a][b]
                      : null;
                  },
                  getMomentStartOf: function (a) {
                    var b = this;
                    return "week" === b.options.time.unit &&
                      !1 !== b.options.time.isoWeekday
                      ? a
                          .clone()
                          .startOf("isoWeek")
                          .isoWeekday(b.options.time.isoWeekday)
                      : a.clone().startOf(b.tickUnit);
                  },
                  determineDataLimits: function () {
                    var a = this;
                    a.labelMoments = [];
                    var c = [];
                    a.chart.data.labels && a.chart.data.labels.length > 0
                      ? (b.each(
                          a.chart.data.labels,
                          function (b) {
                            var d = a.parseTime(b);
                            d.isValid() &&
                              (a.options.time.round &&
                                d.startOf(a.options.time.round),
                              c.push(d));
                          },
                          a
                        ),
                        (a.firstTick = d.min.call(a, c)),
                        (a.lastTick = d.max.call(a, c)))
                  ...
                  buildTicks: function () {
                    var d = this;
                    d.ctx.save();
                    var e = b.getValueOrDefault(
                        d.options.ticks.fontSize,
                        a.defaults.global.defaultFontSize
                      ),
                      f = b.getValueOrDefault(
                        d.options.ticks.fontStyle,
                        a.defaults.global.defaultFontStyle
                      ),
                      g = b.getValueOrDefault(
                        d.options.ticks.fontFamily,
                        a.defaults.global.defaultFontFamily
                      ),
                    ...
                    if (
                      ...
                      (d.ticks = []),
                      (d.unitScale = 1),
                      (d.scaleSizeInUnits = 0),
                      d.options.time.unit)
                    )
                      (d.tickUnit = d.options.time.unit || "day"),
                        (d.displayFormat =
                          d.options.time.displayFormats[d.tickUnit]),
                        (d.scaleSizeInUnits = d.lastTick.diff(
                          d.firstTick,
                          d.tickUnit,
                          !0
                        )),
                        (d.unitScale = b.getValueOrDefault(
                          d.options.time.unitStepSize,
                          1
                        ));
                    else {
                      var i = d.isHorizontal()
                          ? d.width - (d.paddingLeft + d.paddingRight)
                          : d.height - (d.paddingTop + d.paddingBottom),
                        j = d.tickFormatFunction(d.firstTick, 0, []),
                        k = d.ctx.measureText(j).width;
                      k =
                        k * Math.cos(b.toRadians(d.options.ticks.maxRotation)) +
                        e * Math.sin(b.toRadians(d.options.ticks.maxRotation));
                      var l = i / k;
                      (d.tickUnit = "millisecond"),
                        (d.scaleSizeInUnits = d.lastTick.diff(
                          d.firstTick,
                          d.tickUnit,
                          !0
                      ...
                      for (var m = 0, n = c.units[m]; m < c.units.length; ) {
                        if (
                          ((d.unitScale = 1),
                          b.isArray(n.steps) &&
                            Math.ceil(d.scaleSizeInUnits / l) < b.max(n.steps))
                        ) {
                          for (var o = 0; o < n.steps.length; ++o)
                            if (
                              n.steps[o] >= Math.ceil(d.scaleSizeInUnits / l)
                            ) {
                              d.unitScale = b.getValueOrDefault(
                                d.options.time.unitStepSize,
                                n.steps[o]
                        ...
                        if (
                          !1 === n.maxStep ||
                          Math.ceil(d.scaleSizeInUnits / l) < n.maxStep
                        ) {
                          d.unitScale = b.getValueOrDefault(
                            d.options.time.unitStepSize,
                            Math.ceil(d.scaleSizeInUnits / l)
                          );
                          break;
                        }
                        ++m, (n = c.units[m]), (d.tickUnit = n.name);
                        var p = d.firstTick.diff(
                            d.getMomentStartOf(d.firstTick),
                            d.tickUnit,
                            !0
                          ),
                          q = d
                            .getMomentStartOf(
                              d.lastTick.clone().add(1, d.tickUnit)
                            )
                            .diff(d.lastTick, d.tickUnit, !0);
                        (d.scaleSizeInUnits =
                          d.lastTick.diff(d.firstTick, d.tickUnit, !0) + p + q),
                          (d.displayFormat =
                            d.options.time.displayFormats[n.name]);
                      }
                    }
                    var r;
                    if (
                      (d.options.time.min
                        ? (r = d.getMomentStartOf(d.firstTick))
                        : ((d.firstTick = d.getMomentStartOf(d.firstTick)),
                          (r = d.firstTick)),
                      !d.options.time.max)
                    ) {
                      ...
                      t < 0
                        ? (d.lastTick = d.getMomentStartOf(
                            d.lastTick.add(1, d.tickUnit)
                          ))
                        : t >= 0 && (d.lastTick = s),
                        (d.scaleSizeInUnits = d.lastTick.diff(
                          d.firstTick,
                    ...
                    (d.smallestLabelSeparation = d.width),
                      b.each(
                        d.chart.data.datasets,
                        function (a, b) {
                          for (var c = 1; c < d.labelMoments[b].length; c++)
                            d.smallestLabelSeparation = Math.min(
                              d.smallestLabelSeparation,
                              d.labelMoments[b][c].diff(
                                d.labelMoments[b][c - 1],
                                d.tickUnit,
                                !0
                              )
                            );
                      ...
                      d.options.time.displayFormat &&
                        (d.displayFormat = d.options.time.displayFormat),
                      d.ticks.push(d.firstTick.clone());
                    for (var u = 1; u <= d.scaleSizeInUnits; ++u) {
                      var v = r.clone().add(u, d.tickUnit);
                      if (
                        d.options.time.max &&
                        v.diff(d.lastTick, d.tickUnit, !0) >= 0
                      )
                        break;
                      u % d.unitScale == 0 && d.ticks.push(v);
                    }
                    (0 ===
                      d.ticks[d.ticks.length - 1].diff(
                        d.lastTick,
                        d.tickUnit
                      ) &&
                      0 !== d.scaleSizeInUnits) ||
                      (d.options.time.max
                        ? (d.ticks.push(d.lastTick.clone()),
                          (d.scaleSizeInUnits = d.lastTick.diff(
                            d.ticks[0],
                            d.tickUnit,
                            !0
                  ...
                  getLabelForIndex: function (a, b) {
                    var c = this,
                      d =
                        c.chart.data.labels && a < c.chart.data.labels.length
                          ? c.chart.data.labels[a]
                          : "";
                    return (
                      "object" == typeof c.chart.data.datasets[b].data[0] &&
                        (d = c.getRightValue(c.chart.data.datasets[b].data[a])),
                      c.options.time.tooltipFormat &&
                        (d = c
                          .parseTime(d)
                          .format(c.options.time.tooltipFormat)),
                      d
                    );
                  },
                  ...
                  convertTicksToLabels: function () {
                    var a = this;
                    (a.tickMoments = a.ticks),
                      (a.ticks = a.ticks.map(a.tickFormatFunction, a));
                  },
                  getPixelForValue: function (a, b, c) {
                    var e = this;
                    (a && a.isValid) || (a = d(e.getRightValue(a)));
                    var f =
                      a && a.isValid && a.isValid()
                        ? a
                        : e.getLabelMoment(c, b);
                    if (f) {
                  ...
                  getValueForPixel: function (a) {
                    var b = this,
                      ...
                      e =
                        (a -
                          (b.isHorizontal()
                            ? b.left + b.paddingLeft
                            : b.top + b.paddingTop)) /
                        c;
                    return (
                      (e *= b.scaleSizeInUnits),
                      b.firstTick
                        .clone()
                        .add(d.duration(e, b.tickUnit).asSeconds(), "seconds")
                    );
                  },
                  parseTime: function (a) {
                    var b = this;
                    return "string" == typeof b.options.time.parser
                      ? d(a, b.options.time.parser)
                      : "function" == typeof b.options.time.parser
                      ? b.options.time.parser(a)
                      : "function" == typeof a.getMonth || "number" == typeof a
                      ? d(a)
                      : a.isValid && a.isValid()
                      ? a
                      : "string" != typeof b.options.time.format &&
                        b.options.time.format.call
                      ? (console.warn(
                        ...
                        b.options.time.format(a))
                      : d(a, b.options.time.format);
                  },
                });
