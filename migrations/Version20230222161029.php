 ...
 */
final class Version20230222161029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD med_id INT NOT NULL, ADD patient_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_65E8AA0A793E396C ON rendez_vous (med_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_65E8AA0A793E396C ON rendez_vous');
        $this->addSql('DROP INDEX IDX_65E8AA0A6B899279 ON rendez_vous');
        $this->addSql('ALTER TABLE rendez_vous DROP med_id, DROP patient_id');
    }
}
